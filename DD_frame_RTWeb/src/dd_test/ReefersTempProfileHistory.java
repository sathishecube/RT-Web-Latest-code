...
public class ReefersTempProfileHistory extends TestCore
{
	static TestUtil s =new TestUtil();
	static LogisticUtils CS =new LogisticUtils();
	
	public static Map<String, Object[]> RTempProfileHistory(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase)
	{
		ExtentTest node = reports.startTest("ReeferTempProfileHistory");
		String[][] input =TestUtil.getData("ReeferTempProfileHistory");
		...
		try
		{
			...
			{
				System.out.println("Reefer Temperature Profile History Module");
				for (int i=scase-1;i<ecase;i++)
					...
					Robot robot = new Robot();
	  					...
	  					try
	  					{
	  						...
	  						{ 					
	  									...
	  									!(s.isElementPresentcheck(By.xpath(Object.getProperty("ControlProbeIcon")), driver)))
	  							{
	  								...
	  								data.put(""+rc, new Object[] {tc, "ReeferTempProfileHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  								rc++;
	  							...
	  							{	
	  								...
	  								data.put(""+rc, new Object[] {tc, "ReeferTempProfileHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  								rc++;
	  								excel.writePass(tc, counter, sheet, acop);
	  					
	  							}	  				
	  							// Reverting Window to the Normal Size
	  				...
	  				if(tc.equalsIgnoreCase("TC2"))
	  				{
		  				...
		  				else
		  				{
		  					...
		  					Thread.sleep(3000);
		  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("HistoryTempMsgTime"))).getText();
		  					Thread.sleep(2000);
		  					driver.findElement(By.xpath(Object.getProperty("HistoryTempMsg"))).click();
			  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
			  	  			{	
			  	  				System.out.println("inside while");
			  	  				Thread.sleep(1000);
			  	  			}
		  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("HistoryTempMsgTime"))).getText();
		  				...
		  				if(s.dateCompare(sDate, eDate, StartDate)==1 && s.dateCompare(sDate, eDate, EndDate)==1 )
		  				{
		  		  		...
		  		  		{
		  		  			System.out.println("Searched date range is not displayed ");
	  			...
	  			//Minimizing the Window to View all the Controls
	  				WebElement html = driver.findElement(By.tagName("html")); 
	  				for(int m=0;m<2;m++)
	  					html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));
  				...
  				else
  				{
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("TempProfile"), "106", Object.getProperty("TempProfileHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("TempProfile"), "106", Object.getProperty("TempProfileHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-106-datagrid-tbody']/tr/td[2]/a"), driver))	  				
	  					...
	  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-407-datagrid-tbody']/tr"), driver))
	  					{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("TempProfile"), "106", Object.getProperty("TempProfileHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-106-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("TempProfile"), "106", Object.getProperty("TempProfileHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  				...
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-407-datagrid']/div/table[1]/thead/tr[2]"));
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = CS.checkSortedValue(driver, Object, "407");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer Temp-Profile History Status>>>>>>>>>>>>>"+strFilterResult);
		  		...
		  		while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  		 Thread.sleep(1000);
		  			...
		  			WebElement ele = driver.findElement(By.xpath(".//*[@id='div-407-datagrid-tbody']"));
