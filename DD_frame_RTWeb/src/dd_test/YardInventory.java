...
public class YardInventory extends TestCore 
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();
		
	@Test
	public static Map<String, Object[]> yardinventorytestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase) 
	{
		String acop =null;
		int counter =1;
		ExtentTest node = reports.startTest("YardInventory");
		String[][] input =TestUtil.getData("YardInventory");
		...
		try
		{
			...
			{
				System.out.println("Yard Inventory Module");
				for (int i=scase-1;i<ecase;i++)
				{
					long stime = System.currentTimeMillis();
	  				...
	  				if (tc.equalsIgnoreCase("TC1"))
	  				{
	  					...
	  					driver.findElement(By.xpath(Object.getProperty("YardInventoryClick"))).click();
	  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
  						Thread.sleep(1000);
	  					...
	  					if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("RefreshIcon")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("PrintIcon")), driver)) || 
	  		  					...
	  		  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("YIDashboard")), driver)))
	  					{
	  						System.out.println("Page Not loaded Successfully");
  							acop = "YardInventory Page Not Loaded Successfully";
  							node.log(LogStatus.FAIL, acop);
  							data.put(""+rc, new Object[] {tc, "YardInventory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
  							rc++;
	  					...
	  					else
	  					{
  							...
  							acop = "YardInventory Page Loaded Successfully";
  							node.log(LogStatus.PASS, acop);
  							data.put(""+rc, new Object[] {tc, "YardInventory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
  							rc++;
	  				...
	  				if (tc.equalsIgnoreCase("TC2"))
  					{
  						...
  						Thread.sleep(1000);
		  					...
		  					List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-6001-datagrid']/div/table[1]/thead/tr[2]"));
	  				...
	  				if (tc.equalsIgnoreCase("TC4"))
  					{
						...
						acop = "YardInventory - Print window opened successfully";
						node.log(LogStatus.PASS, acop);
						data.put(""+rc, new Object[] {tc, "YardInventory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
						rc++;
						excel.writePass(tc, counter, sheet, acop);
	  				...
	  				if (tc.equalsIgnoreCase("TC5"))
  					{
	  					...
	  					Thread.sleep(2000);
	  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-6001-datagrid-tbody']"));
	  					...
	  					try
	  					{
	  					BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\YardInventoryReport.xls"));
	  					String line;
	  					...
	  					if(recordsCount == pageSize)
	  					{
							...
							acop = "YardInventory - Download Page successfully";
							node.log(LogStatus.PASS, acop);
							data.put(""+rc, new Object[] {tc, "YardInventory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
							rc++;
							excel.writePass(tc, counter, sheet, acop);
	  				...
	  				if(tc.equalsIgnoreCase("TC6"))
	  				{
  						...
  						Thread.sleep(1000);  						
			  				...
			  				if(s.unitofMeasure(driver, Object, Object.getProperty("InventoryClick"), Object.getProperty("YardInventoryClick"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
			  				{
  					...
  					if(tc.equalsIgnoreCase("TC7"))
	  				{
		  				...
		  				if(s.unitofMeasure(driver, Object, Object.getProperty("InventoryClick"), Object.getProperty("YardInventoryClick"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
		  				{
  					...
  					if(tc.equalsIgnoreCase("TC8"))
	  				{
		  				...
		  				if(s.unitofMeasure(driver, Object, Object.getProperty("InventoryClick"), Object.getProperty("YardInventoryClick"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
		  				{
  					...
  					if(tc.equalsIgnoreCase("TC9"))
	  				{
		  				...
		  				if(s.unitofMeasure(driver, Object, Object.getProperty("InventoryClick"), Object.getProperty("YardInventoryClick"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
		  				{
					...
					for(int click=1;click<=rows.size()-1;click++)
					{
  					...
  					if(tc.equalsIgnoreCase("TC12"))
	  				{
  						...
  						strFilterResult = Cs.checkSortedValue(driver, Object, "6001");
  						System.out.println("<<<<<<<<<<<<<<<<<<<<<Yard Inventory Sorting Status>>>>>>>>>>>>>"+strFilterResult);
