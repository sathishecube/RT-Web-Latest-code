				...
				for (int i=scase-1;i<ecase;i++)
	  			{
					Robot robot = new Robot();
		  			...
		  			Thread.sleep(5000);
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-126-datagrid-tbody']/tr[1]/td[1]"), driver))
	  				{
	  				...
	  				int Record = Integer.parseInt(Records);
	  					driver.findElement(By.xpath(Object.getProperty("ExcelDownloadAll"))).click();
		  			 	...
		  			 	try
		  			 	{
		  			 	BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\kishore\\Downloads\\RefuelReport-All.xls"));
		  			 	String line;
