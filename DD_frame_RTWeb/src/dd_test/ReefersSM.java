...
public class ReefersSM extends TestCore 
{
	...
	public static Map<String, Object[]> reeferSMtestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase) 
	{
		String acop =null;
		int counter =1;
		ExtentTest node = reports.startTest("ReefersSM");
		String[][] d1 =TestUtil.getData("ReefersSM");
		...
		try
		{
			...
			{
				System.out.println("Reefer SM Module");
				...
				robot.keyRelease(KeyEvent.VK_ESCAPE);
  				...
  				if(d1[i][0].equalsIgnoreCase("TC1"))
  				{
  					try
  					{
  						...
  						if(!(t.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(t.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
  								...
  								!(t.isElementPresentcheck(By.xpath(Object.getProperty("SMDashboard")), driver)))
  						{
  							System.out.println("Page not loaded Successfully");
  							acop = "Reefers SM Page not Loaded Successfully";
  							node.log(LogStatus.FAIL, acop);
  							data.put(""+rc, new Object[] {d1[i][0], "ReefersSM", d1[i][1], d1[i][8], acop, "Fail", t.timestamp(stime)});
  							rc++;
  						...
  						{	
  							...
  							acop = "Reefers SM Page Loaded Successfully";
  				...
  				if(d1[i][0].equalsIgnoreCase("TC2"))
  				{
	  				try
	  				{
	  					...
	  					if(t.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
	  					{
	  						String Chk=driver.findElement(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a")).getText();
  					...
  					try
  					{
  								...
  								&& t.isElementPresentcheck(By.xpath(Object.getProperty("SetDateRange")),driver) && t.isElementPresentcheck(By.xpath(Object.getProperty("DateCancel")),driver))
  						{
  							...
  							else
  							{
  								...
  								{
  									String EndDateGet = driver.findElement(By.xpath(Object.getProperty("SMLastActionDate"))).getText();
  									driver.findElement(By.xpath(Object.getProperty("SMLastActionTime"))).click();
  									while(t.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
  									{	
  										System.out.println("inside while");
  										Thread.sleep(1000);
  									}
  									String StartDateGet = driver.findElement(By.xpath(Object.getProperty("SMLastActionDate"))).getText();
  				...
  				if(d1[i][0].equalsIgnoreCase("TC4"))
  				{
  					try
  					{
  						...
  						Thread.sleep(8000);
  							...
  							List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-116-datagrid']/div/table[1]/thead/tr[2]"));
  				...
  				if(d1[i][0].equalsIgnoreCase("TC6"))
  				{
  					try
  					{
  								...
  								!(t.isElementPresentcheck(By.xpath(Object.getProperty("SMDashboard")), driver)))
  						{
  							...
  							acop = "Reefers SM Page Re-Loading Failed";
  							node.log(LogStatus.FAIL, acop);
  							data.put(""+rc, new Object[] {d1[i][0], "ReefersSM", d1[i][1], d1[i][8], acop, "Fail", t.timestamp(stime)});
  							rc++;
  							String scr = t.CaptureScreenshot();
  				...
  				if(d1[i][0].equalsIgnoreCase("TC8"))
  				{
  					try
  					{
  						...
  						driver.findElement(By.xpath(Object.getProperty("Downloadthispage"))).click();
  			 		 	Thread.sleep(2000);
  			 		 	WebElement ele = driver.findElement(By.xpath(".//*[@id='div-116-datagrid-tbody']"));
  			 		 	...
  			 		 	if(recordsCount == pageSize)
  			 		 	{
  			 		 		...
  			 		 		acop = "Reefers SM - Print window opened successfully";
  			 		 		node.log(LogStatus.PASS, acop);
  			 		 		data.put(""+rc, new Object[] {d1[i][0], "ReefersSM", d1[i][1], d1[i][8], acop, "Pass", t.timestamp(stime)});
  			 		 		rc++;
  			 		 		excel.writePass(d1[i][0], counter, sheet, acop);  			 		 		
  				...
  				if(d1[i][0].equalsIgnoreCase("TC9"))
  				{
  					try
  					{
  						...
  						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("SM"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
  						{
  				...
  				if(d1[i][0].equalsIgnoreCase("TC10"))
  				{
  					try
  					{
  						...
  						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("SM"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
  						{
  				...
  				if(d1[i][0].equalsIgnoreCase("TC11"))
  				{
  					try
  					{
	  					...
	  					if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("SM"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  					{
  				...
  				if(d1[i][0].equalsIgnoreCase("TC12"))
  				{
  					try
  					{
  						...
  						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("SM"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
  						{
  				...
  				if(d1[i][0].equalsIgnoreCase("TC14"))
  				{
  					try
  					{
						...
						strFilterResult = l.checkSortedValue(driver, Object, "116");
						System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefers SM  Status>>>>>>>>>>>>>"+strFilterResult);
  				...
  				if(d1[i][0].equalsIgnoreCase("TC17"))
                 {
  					...
  					{                       
                        ...
                        driver.findElement(By.xpath(".//*[@id='table-col-116--all-none']/label/span[2]/span")).click();
                        while(t.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
                                                  Thread.sleep(1000);
