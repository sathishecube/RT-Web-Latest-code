			...
			for(int i=scase-1;i<ecase;i++)
			{
				...
				if(d1[i][0].equalsIgnoreCase("TC1"))
				{
					try
					{
						...
						if(!(t.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(t.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
								...
								!(t.isElementPresentcheck(By.xpath(Object.getProperty("FTADashboard")), driver)))
						{
							System.out.println("Page not loaded Successfully");
							acop = "Door Alarm Page not Loaded Successfully";
							node.log(LogStatus.FAIL, acop);
							data.put(""+rc, new Object[] {d1[i][0], "FTA", d1[i][1], d1[i][8], acop, "Fail", t.timestamp(stime)});
							rc++;
						...
						{	
							...
							data.put(""+rc, new Object[] {d1[i][0], "FTA", d1[i][1], d1[i][8], acop, "Pass", t.timestamp(stime)});
							rc++;
				...
				if(d1[i][0].equalsIgnoreCase("TC2"))
				{
					try
					{
						...
						if(t.isElementPresentcheck(By.xpath(".//*[@id='div-141-datagrid-tbody']/tr/td[2]/a"), driver))
						{

							String Chk=driver.findElement(By.xpath(".//*[@id='div-141-datagrid-tbody']/tr/td[2]/a")).getText();
				...
				if(d1[i][0].equalsIgnoreCase("TC4"))
				{
					try
					{
						...
						List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-141-datagrid']/div/table[1]/thead/tr[2]"));
				...
				if(d1[i][0].equalsIgnoreCase("TC5"))
				{
					try
					{
						...
						if(t.isElementPresentcheck(By.xpath(".//*[@id='div-141-datagrid-tbody']/tr/td[2]/a"), driver))
						{
							driver.findElement(By.xpath(".//*[@id='div-141-datagrid-tbody']/tr/td[2]/a")).click();
						}
						else
						{
							System.out.println("Search Failed ... No data Found ");
				...
				if(d1[i][0].equalsIgnoreCase("TC8"))
				{
					try
					{
						...
						try
						{
							BufferedReader reader = new BufferedReader(new FileReader("E:\\workspace\\RT_Web_Automation_Excel_Download\\FTAReport.xls"));
							String line;			 	
							int m=0;
				...
				if(d1[i][0].equalsIgnoreCase("TC9"))
				{
					try
					{
						...
						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("FTA"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
						{
				...
				if(d1[i][0].equalsIgnoreCase("TC10"))
				{
					try
					{
						...
						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FTA"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
						{
				...
				if(d1[i][0].equalsIgnoreCase("TC11"))
				{
					try
					{
						...
						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FTA"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
						{
				...
				if(d1[i][0].equalsIgnoreCase("TC12"))
				{
					try
					{
						...
						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FTA"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
						{
				...
				if(d1[i][0].equalsIgnoreCase("TC14"))
				{
					try
					{
						...
						strFilterResult = l.checkSortedValue(driver, Object, "141");
				...
				if(d1[i][0].equalsIgnoreCase("TC17"))
				{
					...
					try
					{
						...
						driver.findElement(By.xpath(".//*[@id='table-col-141--all-none']/label/span[2]/span")).click();
						while(t.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))                   
							Thread.sleep(1000);
