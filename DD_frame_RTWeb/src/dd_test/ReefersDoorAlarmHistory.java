...
public class ReefersDoorAlarmHistory extends TestCore
{
	static TestUtil s =new TestUtil();
	static LogisticUtils CS =new LogisticUtils();
	
	public static Map<String, Object[]> RDAHistory(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase)
	{
		ExtentTest node = reports.startTest("ReeferDoomAlarmHistory");
		String[][] input =TestUtil.getData("ReeferDoomAlarmHistory");
		...
		{			
			...
			{
				System.out.println("Reefer Door Alarm History Module");
				for (int i=scase-1;i<ecase;i++)
	  			{
					Robot robot = new Robot();
	  				...
	  				if(tc.equalsIgnoreCase("TC1"))
	  				{
	  					...
	  					driver.findElement(By.xpath(Object.getProperty("DoorAlarm"))).click();
		  				...
		  				if(s.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))	  				
		  					driver.findElement(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a")).click();
	  				
	  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  				Thread.sleep(1000);
		  				
	  					Thread.sleep(3000);
	  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-411-datagrid-tbody']/tr"), driver))
	  					{	
		  				
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("DoorAlarmHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("DoorAlarmHistoryDashboard")), driver)))
	  				{
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferDoorAlarmHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  				...
	  				{	
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferDoorAlarmHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))	  				
		  				...
		  				else
		  				{
		  					...
		  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("DAHistoryLstCntDate"))).getText();
		  					Thread.sleep(2000);
		  					driver.findElement(By.xpath(Object.getProperty("DAHistoryLstCnt"))).click();
			  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
			  	  			Thread.sleep(1000);
			  	  			
		  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("DAHistoryLstCntDate"))).getText();
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-411-datagrid-tbody']"));
	  			 	...
	  			 	try
	  			 	{
	  			 	BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\DoorAlarmHistoryReport("+Chk+").xls"));
	  			 	String line;
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("DoorAlarm"), "138", Object.getProperty("DoorAlarmHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-411-datagrid-tbody']/tr"), driver))
  					{	
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("DoorAlarm"), "138", Object.getProperty("DoorAlarmHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))  				
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("DoorAlarm"), "138", Object.getProperty("DoorAlarmHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-411-datagrid-tbody']/tr"), driver))
  					{	
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("DoorAlarm"), "138", Object.getProperty("DoorAlarmHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-411-datagrid-tbody']/tr"), driver))
  					{		  				
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-411-datagrid']/div/table[1]/thead/tr[2]"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = CS.checkSortedValue(driver, Object, "411");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer DoorAlarm History Status>>>>>>>>>>>>>"+strFilterResult);
