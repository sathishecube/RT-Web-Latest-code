...
public class ReefersITAHistory extends TestCore
{
	static TestUtil s =new TestUtil();
	static LogisticUtils CS =new LogisticUtils();
	
	public static Map<String, Object[]> RITAHistory(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase)
	{
		ExtentTest node = reports.startTest("ReefersITAHistory");
		String[][] input =TestUtil.getData("ReefersITAHistory");
		...
		try
		{
			...
			{
				System.out.println("Reefer ITA History Module");
				for (int i=scase-1;i<ecase;i++)
	  			{
					Robot robot = new Robot();
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a"), driver))
	  					...
	  					Thread.sleep(3000);
	  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-115-datagrid-tbody']/tr"), driver))
	  					{
		  				
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("ITAHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("ITAHistoryDashboard")), driver)))
	  				{
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferITAHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  				...
	  				{	
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferITAHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a"), driver))
		  				...
		  				else
		  				{
		  					...
		  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("ITAHistoryConfigONDate"))).getText();
		  					Thread.sleep(2000);
		  					driver.findElement(By.xpath(Object.getProperty("ITAHistoryConfigON"))).click();
			  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
			  	  			Thread.sleep(1000);
			  	  			
		  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("ITAHistoryConfigONDate"))).getText();
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  					Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-115-datagrid-tbody']"));
	  			 	...
	  			 	try
	  			 	{
	  			 	BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\ITAHistoryReport("+Chk+").xls"));
	  			 	String line;
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("ITA"), "114", Object.getProperty("ITAHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-115-datagrid-tbody']/tr"), driver))
  					{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("ITA"), "114", Object.getProperty("ITAHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("ITA"), "114", Object.getProperty("ITAHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("ITA"), "114", Object.getProperty("ITAHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-115-datagrid']/div/table[1]/thead/tr[2]"));
	  				...
	  				System.out.println("Input size : "+arrSplit4.length);
	  				int cnt = 0;
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-114-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = CS.checkSortedValue(driver, Object, "115");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer ITA History Status>>>>>>>>>>>>>"+strFilterResult);
