...
public class ReeferDoorAlarms extends TestCore 
{
	static TestUtil t =new TestUtil();
	static LogisticUtils l =new LogisticUtils();
		
	@Test
	public static Map<String, Object[]> reeferdooralarmtestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase)
	{
		
			String acop =null;
			int counter =1;
			ExtentTest node = reports.startTest("ReefersDoorAlarm");
			String[][] d1 =TestUtil.getData("ReefersDoorAlarm");
			...
			try
			{
				...
				{
					System.out.println("Reefer Door Alarm Module");
				...
				if(d1[i][0].equalsIgnoreCase("TC1"))
				{
					try
					{
						...
						if(!(t.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(t.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
								...
								!(t.isElementPresentcheck(By.xpath(Object.getProperty("DADashboard")), driver)))
						{
							System.out.println("Page not loaded Successfully");
							acop = "Door Alarm Page not Loaded Successfully";
							node.log(LogStatus.FAIL, acop);
							data.put(""+rc, new Object[] {d1[i][0], "ReefersDoorAlarms", d1[i][1], d1[i][8], acop, "Fail", t.timestamp(stime)});
							rc++;
						...
						{	
							...
							data.put(""+rc, new Object[] {d1[i][0], "ReefersDoorAlarms", d1[i][1], d1[i][8], acop, "Pass", t.timestamp(stime)});
							rc++;
				...
				if(d1[i][0].equalsIgnoreCase("TC2"))
				{
					try
					{
						...
						if(t.isElementPresentcheck(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a"), driver))
						{
					
							String Chk=driver.findElement(By.xpath(".//*[@id='div-138-datagrid-tbody']/tr/td[2]/a")).getText();
					...
					try
					{
								...
								&& t.isElementPresentcheck(By.xpath(Object.getProperty("SetDateRange")),driver) && t.isElementPresentcheck(By.xpath(Object.getProperty("DateCancel")),driver))
						{
							...
							else
							{
								...
								{
									String EndDateGet = driver.findElement(By.xpath(Object.getProperty("DALstCntDate"))).getText();
									driver.findElement(By.xpath(Object.getProperty("DALastContact"))).click();
									while(t.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
									{	
										System.out.println("inside while");
										Thread.sleep(1000);
									}
									String StartDateGet = driver.findElement(By.xpath(Object.getProperty("DALstCntDate"))).getText();
				...
				if(d1[i][0].equalsIgnoreCase("TC4"))
				{
					try
					{
						...
						List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-138-datagrid']/div/table[1]/thead/tr[2]"));
				...
				if(d1[i][0].equalsIgnoreCase("TC8"))
				{
					try
					{
						...
						Thread.sleep(2000);
						WebElement ele = driver.findElement(By.xpath(".//*[@id='div-138-datagrid-tbody']"));
				...
				if(d1[i][0].equalsIgnoreCase("TC9"))
				{
					try
					{
						...
						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("DoorAlarm"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
						{
				...
				if(d1[i][0].equalsIgnoreCase("TC10"))
				{
					try
					{
						...
						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("DoorAlarm"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
						{
				...
				if(d1[i][0].equalsIgnoreCase("TC11"))
				{
					try
					{
						...
						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("DoorAlarm"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
						{
				...
				if(d1[i][0].equalsIgnoreCase("TC12"))
				{
					try
					{
						...
						if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("DoorAlarm"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
						{
				...
				if(d1[i][0].equalsIgnoreCase("TC14"))
				{
					try
					{
						...
						strFilterResult = l.checkSortedValue(driver, Object, "138");
  			...
  			if(d1[i][0].equalsIgnoreCase("TC17"))
            {
  				...
  				try
  				{
                   ...
                   driver.findElement(By.xpath(".//*[@id='table-col-138--all-none']/label/span[2]/span")).click();
                   while(t.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))                   
                      Thread.sleep(1000);
