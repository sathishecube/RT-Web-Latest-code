...
import dd_utils.TestUtil;
		...
		public class ReefersSMHistory extends TestCore 
			{
					static TestUtil s =new TestUtil();
					static LogisticUtils CS =new LogisticUtils();
					
				@Test
				public static Map<String, Object[]> reeferSMtestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase)
				{
					String acop =null;
					int counter =1;
					String tc,tcdesc, eopt;
					ExtentTest node = reports.startTest("ReeferSMHistory");
					String[][] d1 =TestUtil.getData("ReeferSMHistory");
				...
				try
				{
					...
					{
						System.out.println("Reefer SM History Module");
				for(int i=scase-1;i<ecase;i++ )
				{
					Robot robot = new Robot();
		  			...
		  			Thread.sleep(1000);
	  					...
	  					driver.findElement(By.xpath(Object.getProperty("SM"))).click();
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
	  				
		  				driver.findElement(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a")).click();
	  				
	  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  				Thread.sleep(1000);
		  				
	  					Thread.sleep(3000);
	  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-117-datagrid-tbody']/tr"), driver))
	  					{	
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("SMHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("SMHistoryDashboard")), driver)))
	  				{
	  					System.out.println("Page not loaded Successfully");
	  					acop = "Reefers SM History Page not Loaded Successfully";
	  					node.log(LogStatus.FAIL, acop);
	  					data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  					String sshot = s.CaptureScreenshot();
	  					excel.writeFail(tc, counter, sheet, acop, sshot);	  					
	  				}
	  				else
	  				{	
	  					System.out.println("Reefer SM History Page loaded Successfully");
	  					acop = "Reefers History Page Loaded Successfully";
	  					node.log(LogStatus.PASS, acop);
	  					data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
		  				...
		  				{
		  					System.out.println("No data found for the this date range");	
		  					acop = "No data";
		  					node.log(LogStatus.PASS, acop);
		  	  				data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
		  	  				rc++;
		  				...
		  				else
		  				{
		  					...
		  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("SMHistoryInitiationTime"))).getText();
		  					Thread.sleep(2000);
		  					driver.findElement(By.xpath(Object.getProperty("SMHistoryInitiation"))).click();
			  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
			  	  			Thread.sleep(1000);
			  	  			
		  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("SMHistoryInitiationTime"))).getText();
		  				...
		  				if(s.dateCompare(sDate, eDate, StartDate)==1 && s.dateCompare(sDate, eDate, EndDate)==1 )
		  				{
		  					...
		  					acop = "Displayed dates are within the given date range";
		  					node.log(LogStatus.PASS, acop);
		  	  				data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
		  	  				rc++;
		  	  				excel.writePass(tc, counter, sheet, acop);		  	  				
		  		  		...
		  		  		else
		  		  		{
		  	  				...
		  	  				acop = "Data's are not displayed for the given date range";
		  	  				node.log(LogStatus.FAIL, acop);
		  	  				data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
		  	  				rc++;
		  	  				String sshot = s.CaptureScreenshot();
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("SMHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
		  					...
		  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("SMHistoryDashboard")), driver)))
		  				{
		  					...
		  					acop = "Refersh - Reefers History Page not Re-Loaded Successfully";
		  					node.log(LogStatus.FAIL, acop);
		  					data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
		  					rc++;
		  					String sshot = s.CaptureScreenshot();
		  				...
		  				{	
		  					...
		  					acop = "Refersh - Reefers History Page Re-Loaded Successfully";
		  					node.log(LogStatus.PASS, acop);
		  					data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
		  					rc++;
		  					excel.writePass(tc, counter, sheet, acop);		  					
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-117-datagrid-tbody']"));
	  			 	...
	  			 	try
	  			 	{
	  			 	BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\SMHistoryReport("+Chk+").xls"));
	  			 	String line;
	  			  ...
	  			  System.out.println(recordsCount+":"+pageSize);
	  			 	if(recordsCount == pageSize)
	  			 	{
	  			 		...
	  			 		acop = "Excel downloaded successfully and the page sizes are matching";
			  			node.log(LogStatus.PASS, acop);
			  			data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
			  			rc++;
			  			excel.writePass(tc, counter, sheet, acop);			  			
	  			 	...
	  			 	else
	  			 	{
		  			 	...
		  			 	acop = "Excel downloaded successfully and the page sizes are not matching";
		  			 	node.log(LogStatus.FAIL, acop);
		  			 	data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
		  			 	rc++;
		  			 	String sshot = s.CaptureScreenshot();
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("SM"), "116", Object.getProperty("SMHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  					System.out.println("Time zone Displayed Successfully");
	  					acop = "Dashboard Tme zone and Settings time zones are same";
	  					node.log(LogStatus.PASS, acop);
	  					data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  					rc++;
	  					excel.writePass(tc, counter, sheet, acop);
	  				...
	  				else
	  				{
	  					...
	  					acop = "Dashboard Tme zone and Settings time zones are not matching";
	  					node.log(LogStatus.FAIL, acop);
	  					data.put(""+rc, new Object[] {tc, "ReeferSMHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  					String sshot = s.CaptureScreenshot();
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("SM"), "116", Object.getProperty("SMHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("SM"), "116", Object.getProperty("SMHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-117-datagrid-tbody']/tr"), driver))
  					{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("SM"), "116", Object.getProperty("SMHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-117-datagrid']/div/table[1]/thead/tr[2]"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-116-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = CS.checkSortedValue(driver, Object, "117");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer SM History Status>>>>>>>>>>>>>"+strFilterResult);
						...
						if(PageList.get(0).getText().equalsIgnoreCase("Prev") && PageList.get(PageList.size()-2).getText().equalsIgnoreCase("Next") && PageList.get(PageList.size()-1).getText().contains("Go To Page"))
						{
							...
							else
							{
								driver.findElement(By.xpath(Object.getProperty("PageDrpdown"))).click();
	  							Thread.sleep(2000);
	  							driver.findElement(By.xpath(Object.getProperty("PageValue"))).sendKeys(d1[i][6]);
	  							...
	  							for(int j=0;j<PageList.size();j++)
	  							{
		  							...
		  							if(PageList.get(j).getText().equalsIgnoreCase(d1[i][6]))
									{
