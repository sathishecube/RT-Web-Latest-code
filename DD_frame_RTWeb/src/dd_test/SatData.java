...
public class SatData extends TestCore 
{
	
	static TestUtil t =new TestUtil();
	static LogisticUtils l =new LogisticUtils();
	@Test
	public static Map<String, Object[]>satdatatestcase(Map<String, Object[]> data, int rc, String sheet, ExtentTest test, int scase, int ecase)
	{
		//TestUtil s =new TestUtil();
		String acop = null;
		int counter = 1;
		ExtentTest node = reports.startTest("SatData");
		String[][] d1 = t.getData("SatData");
		try
		{
			...
			{			
				System.out.println("SatData Module");
			for(int i=scase-1;i<ecase;i++)
			{
				...
				if(d1[i][0].equalsIgnoreCase("TC1"))
				{
					try
					{
						...
						driver.findElement(By.xpath(Object.getProperty("SatData"))).click();
						while(t.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))							
							Thread.sleep(1000);
						if(!(t.isElementPresentcheck(By.xpath(Object.getProperty("UploadOcp")), driver)) || !(t.isElementPresentcheck(By.xpath(Object.getProperty("IntroduceUnit")), driver)) || 
								...
								!(t.isElementPresentcheck(By.xpath(Object.getProperty("GeoExcellAll")), driver))||!(t.isElementPresentcheck(By.xpath(Object.getProperty("SatDataDashboard")), driver)))
						{
							System.out.println("Page not loaded Successfully");
							acop = "SatData Page not Loaded Successfully";
							node.log(LogStatus.FAIL, acop);
							data.put(""+rc, new Object[] {d1[i][0], "SatData", d1[i][1], d1[i][8], acop, "Fail", t.timestamp(stime)});
							rc++;
						...
						{	
							...
							acop = "SatData Page Loaded Successfully";
							node.log(LogStatus.PASS, acop);
							data.put(""+rc, new Object[] {d1[i][0], "SatData", d1[i][1], d1[i][8], acop, "Pass", t.timestamp(stime)});
							rc++;
				...
				if(d1[i][0].equalsIgnoreCase("TC2"))
				{
					try
					{
						...
						if(t.isElementPresentcheck(By.xpath(".//*[@id='div-8-datagrid-tbody']/tr/td[2]/a"), driver))
						{

							String Chk=driver.findElement(By.xpath(".//*[@id='div-8-datagrid-tbody']/tr/td[2]/a")).getText();
				...
				if(d1[i][0].equalsIgnoreCase("TC3"))
				{
					try
					{
						...
						List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-8-datagrid']/div/table[1]/thead/tr[2]"));
				...
				if(d1[i][0].equalsIgnoreCase("TC4"))
				{
					try
					{
						...
						WebElement ele = driver.findElement(By.xpath(".//*[@id='div-8-datagrid-tbody']"));
						...
						try
						{
							BufferedReader reader = new BufferedReader(new FileReader("E:\\workspace\\RT_Web_Automation_Excel_Download\\SATData-All.xls"));
							String line;			 	
							int m=0;
