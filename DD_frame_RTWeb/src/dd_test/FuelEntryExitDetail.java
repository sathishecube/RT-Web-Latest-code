...
public class FuelEntryExitDetail extends TestCore 
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();

	@Test
	public static Map<String, Object[]> entryexitdetailtestcase(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase)
	{
		String acop =null;
		int counter =1;
		ExtentTest node = reports.startTest("FuelEntryExitDetail");
		String[][] d1 =TestUtil.getData("FuelEntryExitDetail");
		System.out.println("FuelEntryExitDetail Module");
				...
				for(int i=scase-1;i<ecase;i++ )
				{
					...
					if(d1[i][0].equalsIgnoreCase("TC1"))
					{
						try
						{
							...
							driver.findElement(By.xpath(Object.getProperty("FuelEntryExitDetail"))).click();
							//System.out.println("before while");
							while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
							{		
								//System.out.println("inside while");
							...
							if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
									...
									!(s.isElementPresentcheck(By.xpath(Object.getProperty("FEEDShowFilter")), driver))||!(s.isElementPresentcheck(By.xpath(Object.getProperty("FEEDDashboard")), driver)))
							{
								System.out.println("Page not loaded Successfully");
								acop = "FuelEntryExitDetail Page not Loaded Successfully";
								node.log(LogStatus.FAIL, acop);
								data.put(""+rc, new Object[] {d1[i][0], "FuelEntryExitDetail", d1[i][1], d1[i][8], acop, "Fail", s.timestamp(stime)});
								rc++;
							...
							{	
								...
								acop = "FuelEntryExitDetail Page Loaded Successfully";
								node.log(LogStatus.PASS, acop);
								data.put(""+rc, new Object[] {d1[i][0], "FuelEntryExitDetail", d1[i][1], d1[i][8], acop, "Pass", s.timestamp(stime)});
								rc++;
					...
					if(d1[i][0].equalsIgnoreCase("TC2"))
					{
						try
						{
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-136-datagrid-tbody']/tr/td[2]/a"), driver))
							{

								String Chk=driver.findElement(By.xpath(".//*[@id='div-136-datagrid-tbody']/tr/td[2]/a")).getText();
					...
					if(d1[i][0].equalsIgnoreCase("TC4"))
					{
						try
						{
							...
							driver.findElement(By.xpath(Object.getProperty("FEEDShowFilter"))).click();
							while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))	  					
								Thread.sleep(1000);


							if(s.isElementPresentcheck(By.xpath(Object.getProperty("FEEDValue")), driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("FEEDTankCapacity")), driver) 
									&& s.isElementPresentcheck(By.xpath(Object.getProperty("FEEDGeofence")), driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("FEEDApplyButton")), driver) 
									&&s.isElementPresentcheck(By.xpath(Object.getProperty("FEEDCancelButton")), driver)&& s.isElementPresentcheck(By.xpath(Object.getProperty("FEEDClearButton")), driver))
									
							{
								System.out.println("Filter Popup window opened Successfully");
								driver.findElement(By.xpath(Object.getProperty("FEEDValue"))).click();
								//driver.findElement(By.xpath(Object.getProperty("OtherSelect"))).click();
								System.out.println("Filter values entered");
								driver.findElement(By.xpath(Object.getProperty("FEEDCancelButton"))).click();
							...
							driver.findElement(By.xpath(Object.getProperty("FFEDShowFilter"))).click();
							Thread.sleep(2000);

							//driver.findElement(By.xpath(Object.getProperty("RFLSHowFilters"))).click();
							boolean strFilterResult = false;
							strFilterResult = Cs.disparity(driver, Object, "135", "geofenceEntryExitReportValue", "3", false, "Text", "FEEDApplyButton","FEEDClearButton");
							...
							Thread.sleep(2000);
							strFilterResult = Cs.disparity(driver, Object, "135", "fuelTankCapacityType", "3", false, "Text", "FEEDApplyButton","FEEDClearButton");
							//s.clearFilter(driver, Object, "OSClearFilter");
							System.out.println("<<<<<<<<<<<<<<<<<<<<<RefuelTransShowFilters Status>>>>>>>>>>>>>"+strFilterResult);
							if (strFilterResult == true)
							{
							...
							driver.findElement(By.xpath(Object.getProperty("FUShowFilter"))).click();
							Thread.sleep(2000);
							strFilterResult = Cs.disparity(driver, Object, "135", "geofenceId", "3", false, "Text", "FEEDApplyButton","FEEDClearButton");
							//s.clearFilter(driver, Object, "OSClearFilter");
							System.out.println("<<<<<<<<<<<<<<<<<<<<<RefuelTransShowFilters Status>>>>>>>>>>>>>"+strFilterResult);
							if (strFilterResult == true)
							{
					...
					if(d1[i][0].equalsIgnoreCase("TC5"))
					{
						try
						{
							...
							List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-136-datagrid']/div/table[1]/thead/tr[2]"));
					...
					if(d1[i][0].equalsIgnoreCase("TC6"))
					{
						try
						{
							...
							else
							{
								...
								acop = "Page Re-Loaded Successfully";
								node.log(LogStatus.PASS, acop);
								data.put(""+rc, new Object[] {d1[i][0], "FuelEntryExitDetail", d1[i][1], d1[i][8], acop, "Pass", s.timestamp(stime)});
								rc++;
								excel.writePass(d1[i][0], counter, sheet, acop);	  					
					...
					if(d1[i][0].equalsIgnoreCase("TC8"))
					{
						try
						{
							...
							WebElement ele = driver.findElement(By.xpath(".//*[@id='div-136-datagrid-tbody']"));
							List<WebElement>page=ele.findElements(By.tagName("tr"));
							//Thread.sleep(7000);
							pageSize=page.size();
							try
							{
								BufferedReader reader = new BufferedReader(new FileReader("E:\\workspace\\RT_Web_Automation_Excel_Download\\GeofenceFuelEntryExitDetailsReport.xls"));
								String line;
					...
					if(d1[i][0].equalsIgnoreCase("TC9"))
					{
						try
						{
							...
							if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics") ,Object.getProperty("FuelEntryExitDetail"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
							{
					...
					if(d1[i][0].equalsIgnoreCase("TC10"))
					{
						try
						{
							...
							if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics"), Object.getProperty("FuelEntryExitDetail"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
							{
					...
					if(d1[i][0].equalsIgnoreCase("TC11"))
					{
						...
						{	
							...
							if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics"), Object.getProperty("FuelEntryExitDetail"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
							{
					...
					if(d1[i][0].equalsIgnoreCase("TC12"))
					{
						try
						{
							...
							if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics"), Object.getProperty("FuelEntryExitDetail"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
							{
					...
					if(d1[i][0].equalsIgnoreCase("TC14"))
					{
						try
						{
							...
							boolean strFilterResult = false;
							strFilterResult = Cs.checkSortedValue(driver, Object, "136");
