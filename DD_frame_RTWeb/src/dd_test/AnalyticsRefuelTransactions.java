...
public class AnalyticsRefuelTransactions extends TestCore 
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();
		
	@Test
	public static Map<String, Object[]> refueltranstestcase(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase)
	{
		String acop =null;
		int counter =1;
		ExtentTest node = reports.startTest("AnalyticsRefuelTransactions");
		String[][] d1 =TestUtil.getData("AnalyticsRefuelTransactions");
		System.out.println("AnalyticsRefuelTransactions Module");
			...
			for(int i=scase-1;i<ecase;i++ )
			{
				...
				long stime=System.currentTimeMillis();
					...
					if(d1[i][0].equalsIgnoreCase("TC1"))
	  				{
						try
						{
							...
							driver.findElement(By.xpath(Object.getProperty("RefuelTransactions"))).click();
							//System.out.println("before while");
							while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
							{		
								//System.out.println("inside while");
	  						...
	  						if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  								...
	  								!(s.isElementPresentcheck(By.xpath(Object.getProperty("RefuelTransShowFilters")), driver)) ||!(s.isElementPresentcheck(By.xpath(Object.getProperty("RFLEvents")), driver)) || 
	  								!(s.isElementPresentcheck(By.xpath(Object.getProperty("FuelUsageSummary")), driver)) ||!(s.isElementPresentcheck(By.xpath(Object.getProperty("FuelEntryExitSummary")), driver)) ||
	  								(!s.isElementPresentcheck(By.xpath(Object.getProperty("FuelEntryExitDetails")), driver)) ||!(s.isElementPresentcheck(By.xpath(Object.getProperty("RefuelTransDashboard")), driver)))
	  						{
	  							System.out.println("Page not loaded Successfully");
	  							acop = "AnalyticsRefuelTransactions Page not Loaded Successfully";
	  							node.log(LogStatus.FAIL, acop);
	  							data.put(""+rc, new Object[] {d1[i][0], "AnalyticsRefuelTransactions", d1[i][1], d1[i][8], acop, "Fail", s.timestamp(stime)});
	  							rc++;
	  						...
	  						{	
	  							...
	  							acop = "AnalyticsRefuelTransactions Page Loaded Successfully";
	  							node.log(LogStatus.PASS, acop);
	  							data.put(""+rc, new Object[] {d1[i][0], "AnalyticsRefuelTransactions", d1[i][1], d1[i][8], acop, "Pass", s.timestamp(stime)});
	  							rc++;
	  				...
	  				if(d1[i][0].equalsIgnoreCase("TC2"))
	  				{
						...
						{		
			  			...
			  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-132-datagrid-tbody']/tr/td[2]/a"), driver))
		  				{
		  					
			  				String Chk=driver.findElement(By.xpath(".//*[@id='div-132-datagrid-tbody']/tr/td[2]/a")).getText();
	  				...
	  				if(d1[i][0].equalsIgnoreCase("TC4"))
	  				{
						...
						{		
	  					...
	  					driver.findElement(By.xpath(Object.getProperty("RefuelTransShowFilters"))).click();
	  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))	  					
  						Thread.sleep(1000);
	  			
						
	  				if(s.isElementPresentcheck(By.xpath(Object.getProperty("Trailer")), driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("City")), driver) 
	  					&& s.isElementPresentcheck(By.xpath(Object.getProperty("State")), driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("Invoice")), driver) 
	  					&& s.isElementPresentcheck(By.xpath(Object.getProperty("GeofenceDropDown")), driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("FilterApply")), driver)
	  					&& s.isElementPresentcheck(By.xpath(Object.getProperty("FilterCancel")), driver))
	  				{
	  					System.out.println("Filter Popup window opened Successfully");
	  					driver.findElement(By.xpath(Object.getProperty("GeofenceDropDown"))).click();
	  				...
	  				driver.findElement(By.xpath(Object.getProperty("RefuelTransShowFilters"))).click();
	  				Thread.sleep(2000);
	  				driver.findElement(By.xpath(Object.getProperty("Trailer"))).clear();
					driver.findElement(By.xpath(Object.getProperty("Trailer"))).sendKeys("773057");
					Thread.sleep(1000);
					driver.findElement(By.xpath(Object.getProperty("FilterApply"))).click();
					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
					{
						Thread.sleep(1000);
					}
					WebElement ele1 = driver.findElement(By.xpath(".//*[@id='div-132-datagrid-tbody']"));
						...
						{
							String getVal = driver.findElement(By.xpath(".//*[@id='div-132-datagrid-tbody']/tr["+p+"]/td[1]")).getText();
							//System.out.println(getVal);
							if (getVal.equals("773057"))
						{
						...
						driver.findElement(By.xpath(Object.getProperty("RefuelTransShowFilters"))).click();
						s.clearFilter(driver, Object, "FilterClearFilter");	
	  				
	  				
						driver.findElement(By.xpath(Object.getProperty("RefuelTransShowFilters"))).click();
		  				Thread.sleep(2000);
		  				driver.findElement(By.xpath(Object.getProperty("City"))).clear();
						driver.findElement(By.xpath(Object.getProperty("City"))).sendKeys("WINTER HAVEN");
						Thread.sleep(1000);
						driver.findElement(By.xpath(Object.getProperty("FilterApply"))).click();
						while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
						{
						...
						WebElement ele2 = driver.findElement(By.xpath(".//*[@id='div-132-datagrid-tbody']"));
							System.out.println(ele2.getTagName());
							List<WebElement>page2=ele2.findElements(By.tagName("tr"));
							System.out.println("PageSize : "+page2.size());
							for (int p = 1; p <=page2.size();p++)
							{
								String getVal = driver.findElement(By.xpath(".//*[@id='div-132-datagrid-tbody']/tr["+p+"]/td[3]")).getText();
								//System.out.println(getVal);
								if (getVal.equals("WINTER HAVEN"))
							{
									System.out.println("Filterex Value displayed");
									acop = "City Filter Value displayed";
									node.log(LogStatus.PASS, acop);
							}
								else
								{	
							...
							driver.findElement(By.xpath(Object.getProperty("RefuelTransShowFilters"))).click();
			  				Thread.sleep(2000);
			  				driver.findElement(By.xpath(Object.getProperty("State"))).clear();
							driver.findElement(By.xpath(Object.getProperty("State"))).sendKeys("FL");
							Thread.sleep(1000);
							driver.findElement(By.xpath(Object.getProperty("FilterApply"))).click();
							while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
							{
							...
							WebElement ele3 = driver.findElement(By.xpath(".//*[@id='div-132-datagrid-tbody']"));
								System.out.println(ele3.getTagName());
								List<WebElement>page3=ele3.findElements(By.tagName("tr"));
								System.out.println("PageSize : "+page3.size());
								for (int p = 1; p <=page3.size();p++)
								{
									String getVal = driver.findElement(By.xpath(".//*[@id='div-132-datagrid-tbody']/tr["+p+"]/td[4]")).getText();
									//System.out.println(getVal);
									if (getVal.equals("FL"))
								{
										System.out.println("Filterex Value displayed");
										acop = "State Filter Value displayed";
										node.log(LogStatus.PASS, acop);
								}
									else
									{	
	  				...
	  				strFilterResult = Cs.disparity(driver, Object, "132", "geofenceId", "5", false, "Text", "FilterApply","FilterClearFilter");
					...
					Thread.sleep(40000);
	  					...
	  					List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-132-datagrid']/div/table[1]/thead/tr[2]"));
					...
					{		
	  				...
	  				if(d1[i][0].equalsIgnoreCase("TC8"))
	  				{
						...
						{		
	  					...
	  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-132-datagrid-tbody']"));
		  			 	...
		  			 	try
		  			 	{
		  			 	BufferedReader reader = new BufferedReader(new FileReader("E:\\workspace\\RT_Web_Automation_Excel_Download\\RefuelTransactionsReport.xls"));
		  			 	String line;
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics") ,Object.getProperty("RefuelTransactions"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			//Test Case 15
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics"), Object.getProperty("RefuelTransactions"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			//Test Case 16
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics"), Object.getProperty("RefuelTransactions"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics"), Object.getProperty("RefuelTransactions"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			//Test Case 19
					...
					{		
  					...
  					boolean strFilterResult = false;
  				 	strFilterResult = Cs.checkSortedValue(driver, Object, "132");
