...
public class ReeferAlarm extends TestCore 
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();
		
	@Test
	public static Map<String, Object[]> reeferAlarmtestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase) 
	{
		String acop =null;
		int counter =1;
		ExtentTest node = reports.startTest("ReefersAlarm");
		String[][] input =TestUtil.getData("ReefersAlarm");
		...
		try
		{
			...
			System.out.println("Reefer Alarm Module");
			for(int i=scase-1;i<ecase;i++ )
			{
				...
				String tc=input[i][0];
  				...
  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
  					...
  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("AlarmDashboard")), driver)))
  				{
  					System.out.println("Page not loaded Successfully");
  					acop = "Reefers Alarm Page not Loaded Successfully";
  					node.log(LogStatus.FAIL, acop);
  					data.put(""+rc, new Object[] {tc, "ReefersAlarms", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
  					rc++;
  				...
  				{	
  					...
  					acop = "Reefers Alarm Page Loaded Successfully";
  					node.log(LogStatus.PASS, acop);
  					data.put(""+rc, new Object[] {tc, "ReefersAlarms", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
  					rc++;
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				...
	  				String Chk=driver.findElement(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a")).getText();
  				...
  				{
  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("AlarmReadTimeDate"))).getText();
  					driver.findElement(By.xpath(Object.getProperty("AlarmReadTime"))).click();
  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
  	  			{	
  	  				System.out.println("inside while");
  	  				Thread.sleep(1000);
  	  			}
  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("AlarmReadTimeDate"))).getText();
  				...
  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))				
  					...
  					List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-103-datagrid']/div/table[1]/thead/tr[2]"));
	  				...
	  				!(s.isElementPresentcheck(By.xpath(Object.getProperty("AlarmDashboard")), driver)))
  				{
  					...
  					acop = "Reefers Alarm Page Re-Loading Failed";
  					node.log(LogStatus.FAIL, acop);
  					data.put(""+rc, new Object[] {tc, "ReefersAlarms", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
  					rc++;
  					String scr = s.CaptureScreenshot();
  				...
  				else
  				{
  					...
  					acop = "Reefers Alarm Page Re-Loaded Successfully";
  					node.log(LogStatus.PASS, acop);
  					data.put(""+rc, new Object[] {tc, "ReefersAlarms", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
  					rc++;
  					excel.writePass(tc, counter, sheet, acop);  					
  				...
  				driver.findElement(By.xpath(Object.getProperty("Downloadthispage"))).click();
  			 	...
  			 	Thread.sleep(2000);
  			 	WebElement ele = driver.findElement(By.xpath(".//*[@id='div-103-datagrid-tbody']"));
  			  ...
  			  List<WebElement>page=ele.findElements(By.tagName("tr"));
  			 	...
  			 	try
  			 	{
  			 	BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\AlarmReport.xls"));
  			 	String line;
  			  ...
  			  System.out.println(recordsCount+":"+pageSize);
  				...
  				if(s.unitofMeasure(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("Alarm"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
  				{
  				...
  				if(s.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Alarm"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
  				{
  				...
  				if(s.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Alarm"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
  				{
  				...
  				if(s.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Alarm"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
  				{
  				...
  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))				
					...
					boolean strFilterResult = false;
				 	strFilterResult = Cs.checkSortedValue(driver, Object, "103");
				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefers Alarms  Status>>>>>>>>>>>>>"+strFilterResult);
  				...
  				if(tc.equalsIgnoreCase("TC17"))
                {
  					try
  					{
                       ...
                       driver.findElement(By.xpath(".//*[@id='table-col-103--all-none']/label/span[2]/span")).click();
                       while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))                      
                          Thread.sleep(1000);
