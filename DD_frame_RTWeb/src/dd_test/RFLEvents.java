...
public class RFLEvents extends TestCore 
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();
		
	@Test
	public static Map<String, Object[]> rfleventstestcase(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase)
	{
		String acop =null;
		int counter =1;
		ExtentTest node = reports.startTest("RFLEvents");
		String[][] d1 =TestUtil.getData("RFLEvents");
		System.out.println("RFLEvents Module");
			...
			for(int i=scase-1;i<ecase;i++ )
			{
				...
				long stime=System.currentTimeMillis();
					...
					if(d1[i][0].equalsIgnoreCase("TC1"))
	  				{
						try
						{
							...
							driver.findElement(By.xpath(Object.getProperty("RFLEvents"))).click();
							//System.out.println("before while");
							while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
							{		
								//System.out.println("inside while");
	  						...
	  						if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  								...
	  								!(s.isElementPresentcheck(By.xpath(Object.getProperty("RFLSHowFilters")), driver))|| !(s.isElementPresentcheck(By.xpath(Object.getProperty("FuelUsageSummary")), driver)) ||
	  								!(s.isElementPresentcheck(By.xpath(Object.getProperty("FuelEntryExitSummary")), driver)) ||(!s.isElementPresentcheck(By.xpath(Object.getProperty("FuelEntryExitDetails")), driver)) ||
	  								!(s.isElementPresentcheck(By.xpath(Object.getProperty("RFLEventsDashboard")), driver)))
	  						{
	  							System.out.println("Page not loaded Successfully");
	  							acop = "RFLEVents Page not Loaded Successfully";
	  							node.log(LogStatus.FAIL, acop);
	  							data.put(""+rc, new Object[] {d1[i][0], "RFLEVents", d1[i][1], d1[i][8], acop, "Fail", s.timestamp(stime)});
	  							rc++;
	  						...
	  						{	
	  							...
	  							acop = "RFLEVents Page Loaded Successfully";
	  							node.log(LogStatus.PASS, acop);
	  							data.put(""+rc, new Object[] {d1[i][0], "RFLEVents", d1[i][1], d1[i][8], acop, "Pass", s.timestamp(stime)});
	  							rc++;
	  				...
	  				if(d1[i][0].equalsIgnoreCase("TC2"))
	  				{
						...
						{		
			  			...
			  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-133-datagrid-tbody']/tr/td[2]/a"), driver))
		  				{
		  					
			  				String Chk=driver.findElement(By.xpath(".//*[@id='div-133-datagrid-tbody']/tr/td[2]/a")).getText();
	  				...
	  				if(s.isElementPresentcheck(By.xpath(Object.getProperty("RFLCity")), driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("RFLSTate")), driver) 
	  					&& s.isElementPresentcheck(By.xpath(Object.getProperty("RFLGeofenceDropDown")), driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("RFLAPplyButton")), driver) 
	  					&& s.isElementPresentcheck(By.xpath(Object.getProperty("RFLGeofenceDropDown")), driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("RFLCancelButton")), driver)
	  					&& s.isElementPresentcheck(By.xpath(Object.getProperty("RFLClearButton")), driver))
	  				{
	  					System.out.println("Filter Popup window opened Successfully");
	  					driver.findElement(By.xpath(Object.getProperty("RFLGeofenceDropDown"))).click();
	  					//driver.findElement(By.xpath(Object.getProperty("OtherSelect"))).click();
	  					System.out.println("Filter values entered");
	  					driver.findElement(By.xpath(Object.getProperty("RFLCancelButton"))).click();
	  				...
	  				driver.findElement(By.xpath(Object.getProperty("RFLSHowFilters"))).click();
	  				Thread.sleep(2000);
	  				driver.findElement(By.xpath(Object.getProperty("RFLCity"))).clear();
					driver.findElement(By.xpath(Object.getProperty("RFLCity"))).sendKeys("SELMA, NC");
					Thread.sleep(1000);
					driver.findElement(By.xpath(Object.getProperty("RFLAPplyButton"))).click();
					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
					{
						Thread.sleep(1000);
					}
					WebElement ele1 = driver.findElement(By.xpath(".//*[@id='div-133-datagrid-tbody']"));
						...
						{
							String getVal = driver.findElement(By.xpath(".//*[@id='div-133-datagrid-tbody']/tr["+p+"]/td[4]")).getText();
							//System.out.println(getVal);
							if (getVal.equals("SELMA, NC"))
						{
						...
						driver.findElement(By.xpath(Object.getProperty("RFLSHowFilters"))).click();
						s.clearFilter(driver, Object, "RFLClearButton");	
	  				
	  				
						driver.findElement(By.xpath(Object.getProperty("RFLSHowFilters"))).click();
		  				Thread.sleep(2000);
		  				driver.findElement(By.xpath(Object.getProperty("RFLSTate"))).clear();
						driver.findElement(By.xpath(Object.getProperty("RFLSTate"))).sendKeys("BRISTOL, NJ");
						Thread.sleep(1000);
						driver.findElement(By.xpath(Object.getProperty("RFLAPplyButton"))).click();
						while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
						{
	  				...
	  				strFilterResult = Cs.disparity(driver, Object, "133", "geofenceId", "3", false, "Text", "FilterApply","FilterClearFilter");
					...
					Thread.sleep(40000);
	  					...
	  					List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-133-datagrid']/div/table[1]/thead/tr[2]"));
					...
					{		
	  				...
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
								...
								!(s.isElementPresentcheck(By.xpath(Object.getProperty("DateTimeIcon")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("TemperatureIcon")), driver)) ||
								!(s.isElementPresentcheck(By.xpath(Object.getProperty("FuelLevelIcon")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("DistanceCalcIcon")), driver)) ||
								!(s.isElementPresentcheck(By.xpath(Object.getProperty("RefuelTransShowFilters")), driver))|| !(s.isElementPresentcheck(By.xpath(Object.getProperty("FuelUsageSummary")), driver)) ||
								!(s.isElementPresentcheck(By.xpath(Object.getProperty("FuelEntryExitSummary")), driver)) ||(!s.isElementPresentcheck(By.xpath(Object.getProperty("FuelEntryExitDetails")), driver)) ||
								!(s.isElementPresentcheck(By.xpath(Object.getProperty("RFLEventsDashboard")), driver)))
	  				{
					...
					{		
	  				...
	  				if(d1[i][0].equalsIgnoreCase("TC8"))
	  				{
						...
						{		
	  					...
	  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-132-datagrid-tbody']"));
		  			 	...
		  			 	try
		  			 	{
		  			 	BufferedReader reader = new BufferedReader(new FileReader("E:\\workspace\\RT_Web_Automation_Excel_Download\\RFLEventsReport.xls"));
		  			 	String line;
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics") ,Object.getProperty("RFLEvents"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			//Test Case 15
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics"), Object.getProperty("RFLEvents"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			//Test Case 16
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics"), Object.getProperty("RFLEvents"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Analytics"), Object.getProperty("RFLEvents"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			//Test Case 19
					...
					{		
  					...
  					boolean strFilterResult = false;
  				 	strFilterResult = Cs.checkSortedValue(driver, Object, "133");
