...
public class ReeferRouteHistory  extends TestCore
{
	...
	public static Map<String, Object[]> RouteHistory(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase)
	{
		...
		try
		{
			...
			{
				System.out.println("Reefer Route History Module");
				for (int i=scase-1;i<ecase;i++)
	  			{
					Robot robot = new Robot();
		  			...
		  			Thread.sleep(1000);
	  					...
	  					driver.findElement(By.xpath(Object.getProperty("Route"))).click();
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-118-datagrid-tbody']/tr/td[2]/a"), driver))
	  				
		  				driver.findElement(By.xpath(".//*[@id='div-118-datagrid-tbody']/tr/td[2]/a")).click();
		  				...
		  				if(s.isElementPresentcheck(By.xpath(".//*[@id='div-119-datagrid-tbody']/tr"), driver))
		  				{
		  				
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("RouteHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("RouteHistoryDashboard")), driver)))
	  				{
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferRouteHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  				...
	  				{	
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferRouteHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-118-datagrid-tbody']/tr/td[2]/a"), driver))
	  					...
	  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-119-datagrid-tbody']/tr"), driver))
	  					{
		  				driver.findElement(By.xpath(Object.getProperty("RouteHistory"))).click();
		  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  					Thread.sleep(1000);
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-118-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-118-datagrid-tbody']/tr/td[2]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-118-datagrid-tbody']/tr/td[2]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-119-datagrid-tbody']"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-118-datagrid-tbody']/tr/td[2]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-119-datagrid-tbody']/tr"), driver))
  					{		  				
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-119-datagrid']/div/table[1]/thead/tr[2]"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-118-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = CS.checkSortedValue(driver, Object, "119");
