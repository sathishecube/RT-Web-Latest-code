...
public class ReefersAlarmHistory  extends TestCore
{
	
	static TestUtil s =new TestUtil();
	static LogisticUtils CS =new LogisticUtils();
	
	public static  Map<String, Object[]> RAlarmHistory(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase)
	{
		ExtentTest node = reports.startTest("ReeferAlarmHistory");
		String[][] input =TestUtil.getData("ReeferAlarmHistory");
		...
		{		
			...
			{
				System.out.println("Reefers Alarm History Module");
				for (int i=scase-1;i<ecase;i++)
	  			{
					Robot robot = new Robot();
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
	  				
		  				driver.findElement(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a")).click();
	  				
	  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  				Thread.sleep(1000);
		  				
	  					Thread.sleep(3000);
	  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-403-datagrid-tbody']/tr"), driver))
	  					{						

	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("AlarmHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("AlarmHistoryDashboard")), driver)))
	  				{
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferAlarmHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  				...
	  				{	
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferAlarmHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
		  				...
		  				else
		  				{
		  					...
		  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("AlarmHistoryLstCntTime"))).getText();
		  					Thread.sleep(2000);
		  					driver.findElement(By.xpath(Object.getProperty("AlarmHistoryLstCnt"))).click();
			  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
			  	  			Thread.sleep(1000);
			  	  			
		  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("AlarmHistoryLstCntTime"))).getText();
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-403-datagrid-tbody']"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("Alarm"), "103", Object.getProperty("AlarmHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-403-datagrid-tbody']/tr"), driver))
  					{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Alarm"), "103", Object.getProperty("AlarmHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-403-datagrid-tbody']/tr"), driver))
  					{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Alarm"), "103", Object.getProperty("AlarmHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Alarm"), "103", Object.getProperty("AlarmHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-403-datagrid']/div/table[1]/thead/tr[2]"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-103-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = CS.checkSortedValue(driver, Object, "403");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer Alarm History Status>>>>>>>>>>>>>"+strFilterResult);
		  							...
		  							if(PageList.get(j).getText().equalsIgnoreCase(input[i][6]))
									{
		  								if(PageList.get(j).getAttribute("class").equalsIgnoreCase("active"))
		  								{
		  									...
		  									else
		  									{
		  			  		  				...
		  			  		  				node.log(LogStatus.FAIL, acop);
		  			  		  					data.put(""+rc, new Object[] {tc, "ReeferAlarmHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
		  			  		  					rc++;String scr = s.CaptureScreenshot();
		  			  		  					excel.writeFail(tc, counter, sheet, acop,scr);		  			  		  					
		  			  		  					break;
		  									}
		  								}
