				...
				for (int i=scase-1;i<ecase;i++)
	  			{
					Robot robot = new Robot();
	  				...
	  				{	
		  				...
		  				driver.findElement(By.xpath(".//*[@id='div-105-sub-lnk']")).click();
		  				Thread.sleep(1000);	  			
	  					...
	  					try
	  					{
	  						...
	  						Thread.sleep(1000);
	  							...
	  							while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  					  		...
	  					  		Thread.sleep(3000);
	  							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-405-datagrid-tbody']/tr"), driver))
	  					  		{  		 				
                ...
                Thread.sleep(5000);
	  			...
	  			Thread.sleep(2000);
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-405-datagrid-tbody']"));
	  			 	...
	  			 	try
	  			 	{
	  			 	BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\MultiTempHistoryReport("+Chk+").xls"));
	  			 	String line;
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
	  				...
	  				int Record = Integer.parseInt(Records);
		  			  ...
		  			  if(Record>10000)
		  			  {
		  			 	...
		  			 	String filePath =	"\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\ReeferMultiTempHistory-All_"+Chk+".csv";
