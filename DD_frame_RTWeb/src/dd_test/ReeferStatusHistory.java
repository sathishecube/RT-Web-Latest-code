				...
				for (int i=scase-1;i<ecase;i++)
				{
					...
					if(tc.equalsIgnoreCase("TC1"))
					{
						try
						{
							...
							if(s.isElementPresent(By.xpath(Object.getProperty("ReeferSearch")), driver))
							{
					...
					if(tc.equalsIgnoreCase("TC7"))
					{
	  				...
	  				int Record = Integer.parseInt(Records);
		  			  ...
		  			  if(Record>10000)
		  			  {
		  			 	...
		  			 	String filePath =	"E:\\workspace\\RT_Web_Automation_Excel_Download\\ReeferAssetHistory-All_"+Chk+".csv";
		  			 	...
		  			 	else
		  			 	{
			  			 	...
			  			 	excel.writeFail(tc, counter, sheet, acop,scr);			  			 	
								...
								driver.findElement(By.xpath(Object.getProperty("ExcelDownloadAll"))).click();
								Thread.sleep(12000);
								CSVReader reader = new CSVReader(new FileReader("E:\\workspace\\RT_Web_Automation_Excel_Download\\ReeferAssetHistory-All_"+Chk+".csv"));
