...
public class ReeferStatusHistory extends TestCore 
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();
	
	@Test
	public static Map<String, Object[]> reeferstatushistroytestcase(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase) 
	{
			ExtentTest node = reports.startTest("ReeferStatusHistory");
			String[][] input =TestUtil.getData("ReeferStatusHistory");
			...
			try 
			{
				...
				{
					System.out.println("Reefer Status History Module");
				for (int i=scase-1;i<ecase;i++)
	  			{
					Robot robot = new Robot();
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-100-datagrid-tbody']/tr/td[2]/a"), driver))
	  				{
	  					...
	  					Thread.sleep(3000);
		  				driver.findElement(By.xpath(Object.getProperty("StatusHistory"))).click();
		  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  					Thread.sleep(1000);
	  				...
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("StatusHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("MultiTempHistory")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("CLMHistory")), driver)) || (!s.isElementPresentcheck(By.xpath(Object.getProperty("AssetCommandHistory")), driver)) ||
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("OrderHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("StatusHistoryDashboard")), driver)))
	  				{
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferStatusHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  				...
	  				{	
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferStatusHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  					rc++;
                ...
                Thread.sleep(5000);
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-100-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-100-datagrid-tbody']/tr/td[2]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-100-datagrid-tbody']/tr/td[2]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-400-datagrid-tbody']"));
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
	  				...
	  				int Record = Integer.parseInt(Records);
		  			  ...
		  			  if(Record>10000)
		  			  {
		  			 	...
		  			 	String filePath =	"\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\ReeferAssetHistory-All_"+Chk+".csv";
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-100-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("Status"), "400", Object.getProperty("StatusHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-100-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Status"), "400", Object.getProperty("StatusHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-100-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Status"), "400", Object.getProperty("StatusHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-100-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Status"), "400", Object.getProperty("StatusHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			driver.findElement(By.xpath(Object.getProperty("Status"))).click();
	  				...
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-400-datagrid']/div/table[1]/thead/tr[2]"));
	  				...
	  				for(int rnum=0;rnum<arrSplit4.length;rnum++)
	  				{
	  					System.out.println(arrSplit4[rnum]);
		  					...
		  					{
		  						System.out.println(arrSplit4[rnum]+" is not present");
					    		notPresent++;
		  					}					
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-100-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = Cs.checkSortedValue(driver, Object, "400");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer Status History Status>>>>>>>>>>>>>"+strFilterResult);
