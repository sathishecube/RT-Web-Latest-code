...
public class ReeferFuel extends TestCore 
{
	static TestUtil t =new TestUtil();
	static LogisticUtils l =new LogisticUtils();

	@Test
	public static Map<String, Object[]>ReefersFuelFlowtestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase)
	{
		ExtentTest node = reports.startTest("ReefersFuelFlow");
		String[][] d1 =TestUtil.getData("ReefersFuelFlow");
		String acop =null;
		int counter =1;
		try 
		{
			...
			{
				System.out.println("Reefer Fuel flow Module");
				for(int i=scase-1;i<ecase;i++ )
				{
					...
					if(d1[i][0].equalsIgnoreCase("TC1"))
					{
						try
						{
							...
							if(!(t.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(t.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
									...
									!(t.isElementPresentcheck(By.xpath(Object.getProperty("FFDashboard")), driver)))
							{
								System.out.println("Page not loaded Successfully");
								acop = "Reefers Fuelflow Page not Loaded Successfully";
								node.log(LogStatus.FAIL, acop);
								data.put(""+rc, new Object[] {d1[i][0], "ReefersFuelFlow", d1[i][1], d1[i][8], acop, "Fail", t.timestamp(stime)});
								rc++;
							...
							{	
								...
								acop = "Reefers Fuelflow Page Loaded Successfully";
								node.log(LogStatus.PASS, acop);
								data.put(""+rc, new Object[] {d1[i][0], "ReefersFuelFlow", d1[i][1], d1[i][8], acop, "Pass", t.timestamp(stime)});
								rc++;
					...
					if(d1[i][0].equalsIgnoreCase("TC2"))
					{
						try
						{
							...
							if(t.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr[1]/td[1]/a"), driver))
							{
								String Chk=driver.findElement(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a")).getText();
						...
						try
						{
									...
									&& t.isElementPresentcheck(By.xpath(Object.getProperty("SetDateRange")),driver) && t.isElementPresentcheck(By.xpath(Object.getProperty("DateCancel")),driver))
							{
								...
								else
								{
									...
									{
										String EndDateGet = driver.findElement(By.xpath(Object.getProperty("FFLstContactDate"))).getText();
										driver.findElement(By.xpath(Object.getProperty("FFLstContact"))).click();
										while(t.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))	  								
											Thread.sleep(1000);

										String StartDateGet = driver.findElement(By.xpath(Object.getProperty("FFLstContactDate"))).getText();
					...
					if(d1[i][0].equalsIgnoreCase("TC4"))
					{
						...
						{	  					
							...
							List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-137-datagrid']/div/table[1]/thead/tr[2]"));
					...
					if(d1[i][0].equalsIgnoreCase("TC5"))
					{
						try
						{
							...
							if(t.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr[1]/td[1]/a"), driver))
							{
								driver.findElement(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr[1]/td[1]/a")).click();
							}
							else
							{
								System.out.println("Search Failed ... No data Found ");
					...
					if(d1[i][0].equalsIgnoreCase("TC6"))
					{
						try
						{
									...
									!(t.isElementPresentcheck(By.xpath(Object.getProperty("FFDashboard")), driver)))
							{
								...
								acop = "Reefers Fuelflow Page Re-Loading Failed";
								node.log(LogStatus.FAIL, acop);
								data.put(""+rc, new Object[] {d1[i][0], "ReefersFuelFlow", d1[i][1], d1[i][8], acop, "Fail", t.timestamp(stime)});
								rc++;
								String scr = t.CaptureScreenshot();
							...
							else
							{
								...
								acop = "Reefers Fuelflow Page Re-Loaded Successfully";
								node.log(LogStatus.PASS, acop);
								data.put(""+rc, new Object[] {d1[i][0], "ReefersFuelFlow", d1[i][1], d1[i][8], acop, "Pass", t.timestamp(stime)});
								rc++;
								excel.writePass(d1[i][0], counter, sheet, acop);	  						
					...
					if(d1[i][0].equalsIgnoreCase("TC8"))
					{
						try
						{
							...
							Thread.sleep(2000);
							WebElement ele = driver.findElement(By.xpath(".//*[@id='div-137-datagrid-tbody']"));
							...
							try
							{
								BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\FuelFlowReport.xls"));
								String line;
								int m=0;
							...
							if(recordsCount == pageSize)
							{
								...
								acop = " Print window opened successfully";
								node.log(LogStatus.PASS, acop);
								data.put(""+rc, new Object[] {d1[i][0], "ReefersFuelFlow", d1[i][1], d1[i][8], acop, "Pass", t.timestamp(stime)});
								rc++;
								excel.writePass(d1[i][0], counter, sheet, acop);	  						
					...
					if(d1[i][0].equalsIgnoreCase("TC9"))
					{
						try
						{
							...
							if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FuelFlow"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
							{
					...
					if(d1[i][0].equalsIgnoreCase("TC10"))
					{
						try
						{
							...
							if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FuelFlow"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
							{
					...
					if(d1[i][0].equalsIgnoreCase("TC11"))
					{
						try
						{
							...
							while(t.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))	  					
								Thread.sleep(1000);
							Thread.sleep(5000);
							if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FuelFlow"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
							{
					...
					if(d1[i][0].equalsIgnoreCase("TC12"))
					{
						try
						{
							...
							if(t.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FuelFlow"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
							{
					...
					if(d1[i][0].equalsIgnoreCase("TC14"))
					{
						try
						{
							...
							strFilterResult = l.checkSortedValue(driver, Object, "137");
							System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefers FuelFlow  Status>>>>>>>>>>>>>"+strFilterResult);
