...
public class ReefersPretripHistory extends TestCore
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();
	
	public static Map<String, Object[]> RPretripHistory(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase)
	{
		String acop =null;
		String Chk ="Null";
		int counter =1;
		ExtentTest node = reports.startTest("ReeferPretripHistory");
		String[][] d1 =TestUtil.getData("ReeferPretripHistory");
		...
		{		
			...
			{
				System.out.println("Reefer Pretrip History Module");
				for (int i=scase-1;i<ecase;i++)
	  			{
					...
					Robot robot = new Robot();
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
	  				
		  				driver.findElement(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a")).click();
	  				
	  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  				Thread.sleep(1000);
		  				
	  					Thread.sleep(3000);
	  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-402-datagrid-tbody']/tr"), driver))
	  					{	
		  				
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("PretripHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("PretripHistoryDashboard")), driver)))
	  				{
	  					...
	  					data.put(""+rc, new Object[] {d1[i][0], "ReeferPretripHistory", d1[i][1], d1[i][8], acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  				...
	  				{	
	  					...
	  					data.put(""+rc, new Object[] {d1[i][0], "ReeferPretripHistory", d1[i][1], d1[i][8], acop, "Pass", s.timestamp(stime)});
	  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
		  				...
		  				else
		  				{
		  					...
		  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("HistoryPretripInitiatedTime"))).getText();
		  					Thread.sleep(2000);
		  					driver.findElement(By.xpath(Object.getProperty("HistoryPretripTimeCol"))).click();
			  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
			  					Thread.sleep(1000);
			  	  			
		  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("HistoryPretripInitiatedTime"))).getText();
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-402-datagrid-tbody']"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("Pretrip"), "102", Object.getProperty("PretripHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Pretrip"), "102", Object.getProperty("PretripHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Pretrip"), "102", Object.getProperty("PretripHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Pretrip"), "102", Object.getProperty("PretripHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-402-datagrid-tbody']/tr"), driver))
  					{	  				
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-402-datagrid']/div/table[1]/thead/tr[2]"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = Cs.checkSortedValue(driver, Object, "402");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer Pretrip History Status>>>>>>>>>>>>>"+strFilterResult);
