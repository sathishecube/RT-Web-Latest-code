...
public class ReeferPretrip extends TestCore 
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();
		
	@Test
	public static Map<String, Object[]> reeferpretriptestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase)
	{
		String acop =null;
		int counter =1;
		ExtentTest node = reports.startTest("ReefersPretrip");
		String[][] d1 =TestUtil.getData("ReefersPretrip");
		...
		try
		{
			...
			System.out.println("Reefer Pretrip Module");
				...
				long stime=System.currentTimeMillis();
					...
					if(d1[i][0].equalsIgnoreCase("TC1"))
	  				...
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("ReeferSearch")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("PretripDashboard")), driver)))
	  				{
	  					System.out.println("Page not loaded Successfully");
	  					acop = "Reefers Pretrip Page not Loaded Successfully";
	  					node.log(LogStatus.FAIL, acop);
	  					data.put(""+rc, new Object[] {d1[i][0], "ReefersPretrip", d1[i][1], d1[i][8], acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  				...
	  				{	
	  					...
	  					acop = "Reefers Pretrip  Page Loaded Successfully";
	  					node.log(LogStatus.PASS, acop);
	  					data.put(""+rc, new Object[] {d1[i][0], "ReefersPretrip", d1[i][1], d1[i][8], acop, "Pass", s.timestamp(stime)});
	  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a"), driver))
	  				{
		  				...
		  				String Chk=driver.findElement(By.xpath(".//*[@id='div-102-datagrid-tbody']/tr/td[2]/a")).getText();
	  				...
	  				{
	  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("PretripInitiatedTimeDate"))).getText();
	  					driver.findElement(By.xpath(Object.getProperty("PretripInitiatedTime"))).click();
	  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  	  			{	
	  	  				System.out.println("inside while");
	  	  				Thread.sleep(1000);
	  	  			}
	  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("PretripInitiatedTimeDate"))).getText();
	  				...
	  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))  				
	  					...
	  					List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-102-datagrid']/div/table[1]/thead/tr[2]"));
		  					...
		  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("PretripDashboard")), driver)))
	  				{
	  					...
	  					acop = " Reefers Pretrip Page Re-Loading Failed";
	  					node.log(LogStatus.FAIL, acop);
	  					data.put(""+rc, new Object[] {d1[i][0], "ReefersPretrip", d1[i][1], d1[i][8], acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  					String scr = s.CaptureScreenshot();
	  				...
	  				else
	  				{
	  					...
	  					acop = " Reefers Pretrip Page Re-Loaded Successfully";
	  					node.log(LogStatus.PASS, acop);
	  					data.put(""+rc, new Object[] {d1[i][0], "ReefersPretrip", d1[i][1], d1[i][8], acop, "Pass", s.timestamp(stime)});
	  					rc++;
	  					excel.writePass(d1[i][0], counter, sheet, acop);
	  				...
	  				driver.findElement(By.xpath(Object.getProperty("Downloadthispage"))).click();
	  			 	...
	  			 	Thread.sleep(2000);
	  			 	WebElement ele = driver.findElement(By.xpath(".//*[@id='div-102-datagrid-tbody']"));
	  			  ...
	  			  System.out.println(recordsCount+":"+pageSize);
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("Pretrip"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Pretrip"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Pretrip"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  				...
	  				if(s.unitofMeasure(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Pretrip"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
  					...
  					boolean strFilterResult = false;
  				 	strFilterResult = Cs.checkSortedValue(driver, Object, "102");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefers Pretrip  Status>>>>>>>>>>>>>"+strFilterResult);
	  				...
	  				if(d1[i][0].equalsIgnoreCase("TC17"))
                    {
	  					try
	  					{
                           ...
                           driver.findElement(By.xpath(".//*[@id='table-col-102--all-none']/label/span[2]/span")).click();
                           while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))                      
                              Thread.sleep(1000);
