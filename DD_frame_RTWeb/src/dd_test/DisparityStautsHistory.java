...
public class DisparityStautsHistory extends TestCore
{
	static TestUtil s =new TestUtil();
	static LogisticUtils CS =new LogisticUtils();
		
	public static Map<String, Object[]> DSHistory(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase)
	{		
		ExtentTest node = reports.startTest("DisparityStatusHistory");
		String[][] input =TestUtil.getData("DisparityStatusHistory");
		
		String acop =null;
		int counter =1;
		System.out.println("Disparity Status History Module");
			...
			{			
				for (int i=scase-1;i<ecase;i++)
					...
					Robot robot = new Robot();
	  				...
	  				if(tc.equalsIgnoreCase("TC1"))
	  				{
	  					try
	  					{
	  						...
	  						driver.findElement(By.xpath(Object.getProperty("Disparity"))).click();
	  						...
	  						if(s.isElementPresentcheck(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a"), driver))
	  							driver.findElement(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a")).click();
	  			
	  						while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  							Thread.sleep(1000);
		  			 				
	  						if(s.isElementPresentcheck(By.xpath(".//*[@id='div-110-datagrid-tbody']/tr"), driver))
	  						{	
	  							if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("DisparityHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  								...
	  								!(s.isElementPresentcheck(By.xpath(Object.getProperty("DisparityHistoryDashboard")), driver)))
	  							{
	  								System.out.println("History page not loaded successfully");
	  								acop = "Reefers History Page not Loaded Successfully";
	  								node.log(LogStatus.FAIL, acop);
	  								data.put(""+rc, new Object[] {tc, "DisparityHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  								rc++;
	  							...
	  							{	
	  								System.out.println("Reefer History Page Loaded successfully");
	  								acop = "Reefers History Page Loaded Successfully";
	  								node.log(LogStatus.PASS, acop);
	  								data.put(""+rc, new Object[] {tc, "DisparityHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  								rc++;
	  						...
	  						if(s.isElementPresentcheck(By.xpath(".//*[@id='div-110-datagrid-tbody']/tr"), driver))
	  						{
	  									...
	  									&& s.isElementPresentcheck(By.xpath(Object.getProperty("SetDateRange")),driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("DateCancel")),driver))
	  							{
		  							...
		  							else
		  							{
		  								...
		  								String EndDateGet = driver.findElement(By.xpath(Object.getProperty("DisparityHistoryLstCntTime"))).getText();
		  								Thread.sleep(2000);
		  								driver.findElement(By.xpath(Object.getProperty("DisparityHistoryLstCnt"))).click();
		  								while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  									Thread.sleep(1000);
			  	  			
		  								String StartDateGet = driver.findElement(By.xpath(Object.getProperty("DisparityHistoryLstCntTime"))).getText();
  				...
  				else
  				{
	  				...
	  				if(tc.equalsIgnoreCase("TC5"))
	  				{
	  					try
	  					{
	  						...
	  						if(s.isElementPresentcheck(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a"), driver))
	  						{
	  							Chk =driver.findElement(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a")).getText();
	  							driver.findElement(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a")).click();
	  						}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
  						Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))	  			
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-110-datagrid-tbody']"));
	  			 	
	  			 	List<WebElement>page=ele.findElements(By.tagName("tr"));	  			 	
	  			 	pageSize=page.size();
	  			 	try
	  			 	{
	  			 	BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\DisparityHistoryReport("+Chk+").xls"));
	  			 	String line;
	  			  ...
	  			  System.out.println(recordsCount);
	  			 	...
	  			 	{
	  			 		System.out.println("Reocrds count matching...");	  			 	
			  			acop = "Count Matching";
			  			node.log(LogStatus.PASS, acop);
			  			data.put(""+rc, new Object[] {tc, "DisparityHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
			  			rc++;
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Disparity") ,Object.getProperty("DisparitySts"), "109", Object.getProperty("DisparityHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
  				...
  				driver.findElement(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a")).click();
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-110-datagrid-tbody']/tr"), driver))
  					{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Disparity"), Object.getProperty("DisparitySts"), "109", Object.getProperty("DisparityHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
  				...
  				driver.findElement(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a")).click();
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-110-datagrid-tbody']/tr"), driver))
  					{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Disparity"), Object.getProperty("DisparitySts"), "109", Object.getProperty("DisparityHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
  				...
  				driver.findElement(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a")).click();
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-110-datagrid-tbody']/tr"), driver))
  					{	  				
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Disparity"), Object.getProperty("DisparitySts"), "109", Object.getProperty("DisparityHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
  				...
  				driver.findElement(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a")).click();
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-110-datagrid-tbody']/tr"), driver))
  					{	  				
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-110-datagrid']/div/table[1]/thead/tr[2]"));
	  				...
	  				if(tc.equalsIgnoreCase("TC12"))
	  				{
	  					try
	  					{
	  					System.out.println( "TC12 Execution startred.....");
	  					Thread.sleep(5000);
	  				driver.findElement(By.xpath(Object.getProperty("FleetSelect"))).click();
	  				driver.findElement(By.xpath(Object.getProperty("AllFleetInput"))).sendKeys(input[i][4]);
	  				driver.findElement(By.xpath(Object.getProperty("AllFleetSelect"))).click();
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-109-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = CS.checkSortedValue(driver, Object, "110");
