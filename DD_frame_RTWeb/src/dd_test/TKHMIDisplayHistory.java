...
public class TKHMIDisplayHistory  extends TestCore
{
	...
	public static Map<String, Object[]> TKHMIHistory(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase)
	{
		...
		try
		{
			...
			{
				System.out.println("TK HMI Display History Module");
				for (int i=scase-1;i<ecase;i++)
				{
					...
					if(tc.equalsIgnoreCase("TC1"))
					{
						try
						{
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-140-datagrid-tbody']/tr/td[2]/a"), driver))
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-140-datagrid-tbody']/tr"), driver))
							{
								...
								if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
										...
										!(s.isElementPresentcheck(By.xpath(Object.getProperty("HMIDisplayDashboardHist")), driver)))
								{
									System.out.println("Page not loaded Successfully");
									acop = "TK HMI History Page not Loaded Successfully";
									node.log(LogStatus.FAIL, acop);
									data.put(""+rc, new Object[] {tc, "TKHMIDisplayHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
									rc++;
								...
								{	
									...
									acop = "TK HMI History Page Loaded Successfully";
									node.log(LogStatus.PASS, acop);
									data.put(""+rc, new Object[] {tc, "TKHMIDisplayHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
									rc++;
					...
					if(tc.equalsIgnoreCase("TC2"))
					{
						try
						{
							...
							Thread.sleep(3000);
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-412-datagrid-tbody']/tr"), driver))
							{
								driver.findElement(By.xpath(Object.getProperty("EditDateRange"))).click();
								while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
									Thread.sleep(1000);
										...
										&& s.isElementPresentcheck(By.xpath(Object.getProperty("SetDateRange")),driver) && s.isElementPresentcheck(By.xpath(Object.getProperty("DateCancel")),driver))
								{
									...
									else
									{
										...
										else
										{
											...
											String EndDateGet = driver.findElement(By.xpath(Object.getProperty("HMIHistoryLastCntDate"))).getText();
											Thread.sleep(2000);
											driver.findElement(By.xpath(Object.getProperty("HMIHistoryLastCnt"))).click();
											while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
												Thread.sleep(1000);

											String StartDateGet = driver.findElement(By.xpath(Object.getProperty("HMIHistoryLastCntDate"))).getText();
					...
					if(tc.equalsIgnoreCase("TC5"))
					{
						...
						{	  					
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-140-datagrid-tbody']/tr/td[2]/a"), driver))
							{
								Chk =driver.findElement(By.xpath(".//*[@id='div-140-datagrid-tbody']/tr/td[2]/a")).getText();
								driver.findElement(By.xpath(".//*[@id='div-140-datagrid-tbody']/tr/td[2]/a")).click();
							}
							while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
								Thread.sleep(1000);
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-412-datagrid-tbody']/tr"), driver))
							{
								...
								WebElement ele = driver.findElement(By.xpath(".//*[@id='div-412-datagrid-tbody']"));
								...
								try
								{
									BufferedReader reader = new BufferedReader(new FileReader("E:\\workspace\\RT_Web_Automation_Excel_Download\\TKHMIDisplayHistoryReport("+Chk+").xls"));
									String line;
					...
					if(tc.equalsIgnoreCase("TC6"))
					{
						try
						{
							...
							{	
								...
								if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("Route"), "118", Object.getProperty("RouteHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
								{
					...
					if(tc.equalsIgnoreCase("TC7"))
					{
						try
						{
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-412-datagrid-tbody']/tr"), driver))
							{
								if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Route"), "118", Object.getProperty("RouteHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
								{
					...
					if(tc.equalsIgnoreCase("TC8"))
					{
						try
						{
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-412-datagrid-tbody']/tr"), driver))
							{
								if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Route"), "118", Object.getProperty("RouteHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
								{
					...
					if(tc.equalsIgnoreCase("TC9"))
					{
						try
						{
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-412-datagrid-tbody']/tr"), driver))
							{
								...
								if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Route"), "118", Object.getProperty("RouteHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
								{
					...
					if(tc.equalsIgnoreCase("TC11"))
					{
						try
						{
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-412-datagrid-tbody']/tr"), driver))
							{		  				
								List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-412-datagrid']/div/table[1]/thead/tr[2]"));
					...
					if(tc.equalsIgnoreCase("TC12"))
					{
						try
						{
							...
							if(s.isElementPresentcheck(By.xpath(".//*[@id='div-412-datagrid-tbody']/tr"), driver))
							{
								...
								strFilterResult = CS.checkSortedValue(driver, Object, "412");
								System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer Route History Stauts>>>>>>>>>>>>>"+strFilterResult);
