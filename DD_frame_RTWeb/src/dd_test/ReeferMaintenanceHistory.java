...
public class ReeferMaintenanceHistory extends TestCore 
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();
	
	@Test
	public static Map<String, Object[]> reefermaintenancehistroytestcase(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase) 
	{
			ExtentTest node = reports.startTest("ReeferMaintenanceHistory");
			String[][] input =TestUtil.getData("ReeferMaintenanceHistory");
			...
			try 
			{
				...
				{
					System.out.println("Reefer Maintenance History Module");
				for (int i=scase-1;i<ecase;i++)
					...
					Robot robot = new Robot();
	  				...
	  				if(tc.equalsIgnoreCase("TC1"))
	  				{
		  				...
		  				driver.findElement(By.xpath(Object.getProperty("AllFleetSelect"))).click();
				  			...
				  			while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
								...
								if(s.isElementPresentcheck(By.xpath(".//*[@id='div-401-datagrid-tbody']/tr"), driver))
		  					{
			  				...
			  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
			  					...
			  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("RMHDashboard")), driver)))
			  				{
			  					System.out.println("Page not loaded Successfully");
			  					acop = "Reefers Maintenance History Page not Loaded ";
			  					node.log(LogStatus.FAIL, acop);
			  					data.put(""+rc, new Object[] {tc, "ReeferMaintenanceHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
			  					rc++;
			  				...
			  				{	
			  					...
			  					acop = "Reefers Maintenance History Page Loaded Successfully";
			  					node.log(LogStatus.PASS, acop);
			  					data.put(""+rc, new Object[] {tc, "ReeferMaintenanceHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
			  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-101-datagrid-tbody']/tr/td[2]/a"), driver))
		  				...
		  				else
		  				{
		  					...
		  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("RMHLastContact"))).getText();
		  					Thread.sleep(2000);
		  					driver.findElement(By.xpath(Object.getProperty("RMHMessageStampClick"))).click();
			  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
			  	  			Thread.sleep(1000);
			  	  			
		  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("RMHLastContact"))).getText();
			  			...
			  			Thread.sleep(1000);
			  				...
			  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
				  					...
				  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("RMHDashboard")), driver)))
				  				{
				  					...
				  					acop = "Reefers Maintenance History Page not Re-Loaded Successfully";
				  					node.log(LogStatus.FAIL, acop);
				  					data.put(""+rc, new Object[] {tc, "ReeferMaintenanceHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
				  					rc++;
				  					String scr = s.CaptureScreenshot();
				  				...
				  				{	
				  					...
				  					acop = "Reefers Maintenance History Page Re-Loaded Successfully";
				  					node.log(LogStatus.FAIL, acop);
				  					data.put(""+rc, new Object[] {tc, "ReeferMaintenanceHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
				  					rc++;
				  					excel.writePass(tc, counter, sheet, acop);
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-101-datagrid-tbody']/tr/td[2]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-101-datagrid-tbody']/tr/td[2]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-101-datagrid-tbody']/tr/td[2]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-401-datagrid-tbody']"));
  				...
  				if(s.isElementPresentcheck(By.xpath(".//*[@id='div-401-datagrid-tbody']/tr"), driver))
  				{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("Maintenance"), "101", Object.getProperty("MaintenanceHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-101-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Maintenance"), "101", Object.getProperty("MaintenanceHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-101-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Maintenance"), "101", Object.getProperty("MaintenanceHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  		...
	  		Thread.sleep(1000);
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-101-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Maintenance"), "101", Object.getProperty("MaintenanceHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-101-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-401-datagrid']/div/table[1]/thead/tr[2]"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-101-datagrid-tbody']/tr/td[2]/a"), driver))
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = Cs.checkSortedValue(driver, Object, "401");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer Maintenance History Status>>>>>>>>>>>>>"+strFilterResult);
							...
							else
							{
								driver.findElement(By.xpath(Object.getProperty("PageDrpdown"))).click();
	  							...
	  							for(int j=0;j<PageList.size();j++)
	  							{
		  							...
		  							if(PageList.get(j).getText().equalsIgnoreCase(input[i][9]))
									{
