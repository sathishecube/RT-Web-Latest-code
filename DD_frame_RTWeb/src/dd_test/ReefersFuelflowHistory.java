...
import dd_utils.TestUtil;
				...
				public class ReefersFuelflowHistory extends TestCore 
				{
					static TestUtil s =new TestUtil();
					static LogisticUtils CS =new LogisticUtils();
					
				@Test
				public static Map<String, Object[]> reeferFuelflowtestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase)
				{
					String acop =null;
					int counter =1;
					String tc,tcdesc, eopt;
					ExtentTest node = reports.startTest("ReeferFuelFlowHistory");
					String[][] d1 =TestUtil.getData("ReeferFuelFlowHistory");
				...
				try
				{
					...
					{
						System.out.println("Reefer Fuel Flow History Module");
				for(int i=scase-1;i<ecase;i++ )
				{
	  			...
	  			Thread.sleep(1000);
  					...
  					driver.findElement(By.xpath(Object.getProperty("FuelFlow"))).click();
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a"), driver))
  		
	  				driver.findElement(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a")).click();
  			
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  				
  					Thread.sleep(3000);
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-410-datagrid-tbody']/tr"), driver))
  					{				
	  				
  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("FuelFlowHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
  					...
  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("ControlProbeIcon")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("FuelFlowHistoryDashboard")), driver)))
  				{
  					...
  					data.put(""+rc, new Object[] {tc, "ReeferFuelFlowHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
  					rc++;
  				...
  				{	
  					...
  					data.put(""+rc, new Object[] {tc, "ReeferFuelFlowHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
  					rc++;
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a"), driver))
	  				...
	  				if(Records.equalsIgnoreCase("0"))
	  				{
	  					...
	  					acop = "No data found for the event Search";
	  					node.log(LogStatus.PASS, acop);
	  	  				data.put(""+rc, new Object[] {tc, "ReeferFuelFlowHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  	  				rc++;
	  	  				excel.writePass(tc, counter, sheet, acop);	  					
	  				...
	  				else
	  				{
	  					...
	  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("FFHistoryLstCntDate"))).getText();
	  					Thread.sleep(2000);
	  					driver.findElement(By.xpath(Object.getProperty("FFHistoryLstCnt"))).click();
		  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  	  			Thread.sleep(1000);
		  	  			
	  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("FFHistoryLstCntDate"))).getText();
  			...
  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a"), driver))
				{
  				Chk =driver.findElement(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a")).getText();
  				driver.findElement(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a")).click();
				}
					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
  					Thread.sleep(1000);
  			...
  			if(!Chk.equalsIgnoreCase(cut))
  			{
  				...
  				driver.findElement(By.xpath(Object.getProperty("ExcelDownload"))).click();
					...
					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-410-datagrid-tbody']"));
  			 	...
  			 	try
  			 	{
  			 	BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\FuelFlowHistoryReport("+Chk+").xls"));
  			 	String line;
  			  ...
  			  System.out.println(recordsCount+":"+pageSize);
  			 	if(recordsCount == pageSize)
  			 	{
		  			...
		  			acop = "Excel downloaded successfully and Count Matching";
		  			node.log(LogStatus.PASS, acop);
		  			data.put(""+rc, new Object[] {tc, "ReeferFuelFlowHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
		  			rc++;
		  			excel.writePass(tc, counter, sheet, acop);		  			
  			 	...
  			 	else
  			 	{
	  			 	...
	  			 	acop = "Excel downloaded successfully and Counts are not Matching";
	  			 	node.log(LogStatus.FAIL, acop);
	  			 	data.put(""+rc, new Object[] {tc, "ReeferFuelFlowHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  			 	rc++;
	  			 	String sshot = s.CaptureScreenshot();
  		...
  		Thread.sleep(1000);
			...
			Thread.sleep(1000);
  			...
  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a"), driver))
  				...
  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("FuelFlow"), "137", Object.getProperty("FuelFlowHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
  				{
  			...
  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a"), driver))
  				...
  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FuelFlow"), "137", Object.getProperty("FuelFlowHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
  				{
  			...
  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a"), driver))
  				...
  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FuelFlow"), "137", Object.getProperty("FuelFlowHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
  				{
  			...
  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a"), driver))
  				...
  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("FuelFlow"), "137", Object.getProperty("FuelFlowHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
  				{
  			...
  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a"), driver))
  				...
  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-410-datagrid']/div/table[1]/thead/tr[2]"));
  			...
  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-137-datagrid-tbody']/tr/td[1]/a"), driver))
  				...
  				boolean strFilterResult = false;
				 	strFilterResult = CS.checkSortedValue(driver, Object, "410");
				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer FuelFlow History Status>>>>>>>>>>>>>"+strFilterResult);
