...
public class OrderHistory extends TestCore 
				{
					static TestUtil s =new TestUtil();
					static LogisticUtils CS =new LogisticUtils();
					
				@Test
				public static Map<String, Object[]> ReefersOrderHistorytestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase)
				{
					String acop =null;
					int counter =1;
					String tc,tcdesc, eopt;
					
					ExtentTest node = reports.startTest("ReeferOrderHistory");
					String[][] d1 =TestUtil.getData("ReeferOrderHistory");
				...
				try
				{
					...
					{
						System.out.println("Reefer Order History Module");
				for(int i=scase-1;i<ecase;i++ )
				{
					Robot robot = new Robot();
		  			...
		  			driver.findElement(By.xpath(Object.getProperty("Orders"))).click();
		  			while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  			Thread.sleep(1000);
	  				...
	  				{
		  				driver.findElement(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a")).click();
	  				}
	  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  				Thread.sleep(1000);
		  				
	  					Thread.sleep(3000);
	  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-122-datagrid-tbody']/tr"), driver))
	  					{
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("OrderHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("ControlProbeIcon")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("OrderHistoryDashboard")), driver)))
	  				{
	  					...
	  					data.put(""+rc, new Object[] {tc, "OrderHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  				...
	  				{	
	  					...
	  					data.put(""+rc, new Object[] {tc, "OrderHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a"), driver))
		  				...
		  				else
		  				{
		  					...
		  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("OrderHistoryLstCntTime"))).getText();
		  					Thread.sleep(2000);
		  					driver.findElement(By.xpath(Object.getProperty("OrderHistoryLstCnt"))).click();
			  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
			  	  			Thread.sleep(1000);
			  	  			
		  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("OrderHistoryLstCntTime"))).getText();
	  		...
	  		Thread.sleep(1000);
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-122-datagrid-tbody']"));
	  			 	...
	  			 	try
	  			 	{
	  			 	BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\OrderHistoryReport("+Chk+").xls"));
	  			 	String line;
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Orders") ,Object.getProperty("OrderStatus"), "121", Object.getProperty("OrderHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-122-datagrid-tbody']/tr"), driver))
  					{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Orders"), Object.getProperty("OrderStatus"), "121", Object.getProperty("OrderHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-122-datagrid-tbody']/tr"), driver))
  					{
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Orders"), Object.getProperty("OrderStatus"), "121", Object.getProperty("OrderHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-122-datagrid-tbody']/tr"), driver))
  					{	  				
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Orders"), Object.getProperty("OrderStatus"), "121", Object.getProperty("OrderHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a"), driver))
	  				...
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-122-datagrid']/div/table[1]/thead/tr[2]"));
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-121-datagrid-tbody']/tr/td[1]/a"), driver))
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = CS.checkSortedValue(driver, Object, "122");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Orders OrderStatus History Status>>>>>>>>>>>>>"+strFilterResult);
