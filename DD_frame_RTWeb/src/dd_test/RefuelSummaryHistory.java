...
public class RefuelSummaryHistory extends TestCore 
{
	static TestUtil s =new TestUtil();
	static LogisticUtils Cs =new LogisticUtils();
		
	@Test
	public static Map<String, Object[]> refuelsummaryhistorytestcases(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test,int scase,int ecase) 
	{
		String acop =null;
		int counter =1;
		ExtentTest node = reports.startTest("FuelRefuelSummaryHistory");
		String[][] input =TestUtil.getData("FuelRefuelSummaryHistory");	
		...
		try
		{
			...
			{
				System.out.println("Fuel Refuel Summary History Module");
				for (int i=scase-1;i<ecase;i++)
				{
					...
					String tc=input[i][0];
	  				...
	  				if (tc.equalsIgnoreCase("TC1"))
	  				{
	  					...
	  					driver.findElement(By.xpath(Object.getProperty("RefuelSummaryHistoryClick"))).click();
	  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
  						Thread.sleep(1000);
	  					...
	  					if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("RefreshIcon")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("PrintIcon")), driver)) ||
  								...
  								!(s.isElementPresentcheck(By.xpath(Object.getProperty("ControlProbeIcon")), driver))|| !(s.isElementPresentcheck(By.xpath(Object.getProperty("RSHDashBoard")), driver)))
	  					{
	  						System.out.println("Page not loaded Successfully");
  							acop = "RefuelSummaryHistory Page not Loaded Successfully";
  							node.log(LogStatus.FAIL, acop);
  							data.put(""+rc, new Object[] {tc, "RefuelSummaryHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
  							rc++;
	  					...
	  					else
	  					{
  							...
  							acop = "RefuelSummaryHistory Page Loaded Successfully";
  							node.log(LogStatus.PASS, acop);
  							data.put(""+rc, new Object[] {tc, "RefuelSummaryHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
  							rc++;
	  				...
	  				if (tc.equalsIgnoreCase("TC2"))
  					{
	  					...
	  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
		  					...
		  					List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-128-datagrid']/div/table[1]/thead/tr[2]"));
	  				...
	  				if (tc.equalsIgnoreCase("TC3"))
  					{
	  					...
	  					driver.findElement(By.xpath(Object.getProperty("RSHDetailsClick"))).click();
	  					List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-128-datagrid']/div/table[1]/thead/tr[1]"));
	  					List<ArrayList<String>> rowsData = new ArrayList<ArrayList<String>>();
	  					System.out.println("No.of rows "+rows.size());
	  					for(WebElement row:rows){
	  					List<WebElement> rowElements = row.findElements(By.xpath("th"));
	  				...
	  				if (tc.equalsIgnoreCase("TC5"))
  					{
						...
						acop = "RefuelSummaryHistory - Print window opened successfully";
						node.log(LogStatus.PASS, acop);
						data.put(""+rc, new Object[] {tc, "RefuelSummaryHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
						rc++;
						excel.writePass(tc, counter, sheet, acop);						
	  				...
	  				if (tc.equalsIgnoreCase("TC6"))
  					{
	  					...
	  					Thread.sleep(2000);
	  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-128-datagrid-tbody']"));
	  					...
	  					if(recordsCount == pageSize)
	  					{
							...
							acop = "RefuelSummaryHistory - Download Page successfully";
							node.log(LogStatus.PASS, acop);
							data.put(""+rc, new Object[] {tc, "RefuelSummaryHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
							rc++;
							excel.writePass(tc, counter, sheet, acop);
	  				...
	  				if(tc.equalsIgnoreCase("TC7"))
	  				{
  						...
  						Thread.sleep(1000); 						
			  				...
			  				if(s.unitofMeasure(driver, Object, Object.getProperty("FuelClick"), Object.getProperty("RefuelSummaryHistoryClick"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
			  				{
	  				...
	  				if(tc.equalsIgnoreCase("TC8"))
	  				{
		  				...
		  				if(s.unitofMeasure(driver, Object, Object.getProperty("FuelClick"), Object.getProperty("RefuelSummaryHistoryClick"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
		  				{
	  				...
	  				if(tc.equalsIgnoreCase("TC9"))
	  				{
		  				...
		  				if(s.unitofMeasure(driver, Object, Object.getProperty("FuelClick"), Object.getProperty("RefuelSummaryHistoryClick"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
		  				{
	  				...
	  				if(tc.equalsIgnoreCase("TC10"))
	  				{
		  				...
		  				if(s.unitofMeasure(driver, Object, Object.getProperty("FuelClick"), Object.getProperty("RefuelSummaryHistoryClick"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
		  				{
