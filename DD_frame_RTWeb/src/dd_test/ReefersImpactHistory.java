...
public class ReefersImpactHistory extends TestCore
{
	static TestUtil s =new TestUtil();
	static LogisticUtils CS =new LogisticUtils();
	
	public static Map<String, Object[]> RImpactHistory(Map<String, Object[]> data, int rc ,String sheet, ExtentTest test ,int scase,int ecase)
	{
		ExtentTest node = reports.startTest("ReefersImpactHistory");
		String[][] input =TestUtil.getData("ReefersImpactHistory");
		...
		try
		{
			...
			{
				System.out.println("Reefer Impact History Module");
				for (int i=scase-1;i<ecase;i++)
	  			{
					Robot robot = new Robot();
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a"), driver))
	  					...
	  					Thread.sleep(3000);
	  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-113-datagrid-tbody']/tr"), driver))
	  					{	
		  				
	  				if(!(s.isElementPresentcheck(By.xpath(Object.getProperty("ImpactHistory")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("EditDateRange")), driver)) || 
	  					...
	  					!(s.isElementPresentcheck(By.xpath(Object.getProperty("ControlProbeIcon")), driver)) || !(s.isElementPresentcheck(By.xpath(Object.getProperty("ImpactHistoryDashboard")), driver)))
	  				{
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferImpactHistory", tcdesc, eopt, acop, "Fail", s.timestamp(stime)});
	  					rc++;
	  				...
	  				{	
	  					...
	  					data.put(""+rc, new Object[] {tc, "ReeferImpactHistory", tcdesc, eopt, acop, "Pass", s.timestamp(stime)});
	  					rc++;
		  			...
		  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a"), driver))
		  				...
		  				else
		  				{
		  					...
		  					String EndDateGet = driver.findElement(By.xpath(Object.getProperty("ImpactHistoryLstCntDate"))).getText();
		  					Thread.sleep(2000);
		  					driver.findElement(By.xpath(Object.getProperty("ImpactHistoryLstCnt"))).click();
			  				while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
			  	  			Thread.sleep(1000);
			  	  			
		  					String StartDateGet = driver.findElement(By.xpath(Object.getProperty("ImpactHistoryLstCntDate"))).getText();
	  		...
	  		Thread.sleep(1000);
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a"), driver))
  				{
	  				Chk =driver.findElement(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a")).getText();
	  				driver.findElement(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a")).click();
  				}
  					while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
	  				Thread.sleep(1000);
	  			...
	  			if(!Chk.equalsIgnoreCase(cut))
	  			{
  					...
  					WebElement ele = driver.findElement(By.xpath(".//*[@id='div-113-datagrid-tbody']"));
	  			 	...
	  			 	try
	  			 	{
	  			 	BufferedReader reader = new BufferedReader(new FileReader("\\\\amxserver\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\ImpactHistoryReport("+Chk+").xls"));
	  			 	String line;
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a"), driver))
	  				...
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers") ,Object.getProperty("Impact"), "112", Object.getProperty("ImpactHistory"), Object.getProperty("DateTimeIcon"), Object.getProperty("TimeTooltip"), Object.getProperty("TimeTooltipval"), Object.getProperty("Timezone")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-113-datagrid-tbody']/tr"), driver))
  					{	
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Impact"), "112", Object.getProperty("ImpactHistory"), Object.getProperty("TemperatureIcon"), Object.getProperty("TempTooltip"), Object.getProperty("TempTooltipval"), Object.getProperty("TemperatureUnit")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-113-datagrid-tbody']/tr"), driver))
  					{	
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Impact"), "112", Object.getProperty("ImpactHistory"), Object.getProperty("FuelLevelIcon"), Object.getProperty("FuelTooltip"), Object.getProperty("FuelTooltipval"), Object.getProperty("FuelLevel")))
	  				{
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-113-datagrid-tbody']/tr"), driver))
  					{		  				
	  				if(s.unitofMeasure1(driver, Object, Object.getProperty("Reefers"), Object.getProperty("Impact"), "112", Object.getProperty("ImpactHistory"), Object.getProperty("DistanceCalcIcon"), Object.getProperty("DistanceTooltip"), Object.getProperty("DistanceTooltipval"), Object.getProperty("DistanceUnit")))
	  				{
	  		...
	  		Thread.sleep(1000);
	  			...
	  			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-112-datagrid-tbody']/tr/td[1]/a"), driver))
  					...
  					if(s.isElementPresentcheck(By.xpath(".//*[@id='div-113-datagrid-tbody']/tr"), driver))
  					{		  				
	  				List<WebElement> rows = driver.findElements(By.xpath(".//*[@id='div-113-datagrid']/div/table[1]/thead/tr[2]"));
	  			...
	  			Thread.sleep(1000);
	  				...
	  				boolean strFilterResult = false;
  				 	strFilterResult = CS.checkSortedValue(driver, Object, "113");
  				 	System.out.println("<<<<<<<<<<<<<<<<<<<<<Reefer Impact History Status>>>>>>>>>>>>>"+strFilterResult);
