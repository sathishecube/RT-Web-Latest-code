...
public class CmdHistoryUtil 
{
	...
	public boolean search(WebDriver driver, Properties obj, String assetId)
	{
		...
		try
		{
			...
			String AssetId="Null";
			if(s.isElementPresentcheck(By.xpath(".//*[@id='div-301-datagrid-tbody']/tr/td[2]/a"), driver))
			{
				System.out.println("Search returned a result... Checking...");
				AssetId = driver.findElement(By.xpath(".//*[@id='div-301-datagrid-tbody']/tr/td[2]/a")).getText();
				AssetId=s.cutString(AssetId, "\n");
			}
			else 
			{
				System.out.println("Search returned no result...");
				status=false;
			}
		...
		try
		{
					 ...
					 && driver.findElement(By.xpath(obj.getProperty("SetDateRange"))).isDisplayed() && driver.findElement(By.xpath(obj.getProperty("DateCancel"))).isDisplayed())
			{
				...
				else
				{
					...
					{
						String EndDateGet = driver.findElement(By.xpath(obj.getProperty("CHSentTimeVal"))).getText();
						driver.findElement(By.xpath(obj.getProperty("CHSentTime"))).click();
						while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
						{
							Thread.sleep(2000);
						}
						
						String StartDateGet = driver.findElement(By.xpath(obj.getProperty("CHSentTimeVal"))).getText();
	...
	public boolean loadDashboard(WebDriver driver, Properties obj)
	{
		...
		try
		{
			if((s.isElementPresentcheck(By.xpath(obj.getProperty("CHHeaderReefer")), driver)) && (s.isElementPresentcheck(By.xpath(obj.getProperty("CHHeaderCommand")), driver))
			&& (s.isElementPresentcheck(By.xpath(obj.getProperty("CHHeaderCmd")),driver)) && (s.isElementPresentcheck(By.xpath(obj.getProperty("CHHeaderCMDStatus")),driver))
			&& (s.isElementPresentcheck(By.xpath(obj.getProperty("CHHeaderOriginMachine")),driver)) && (s.isElementPresentcheck(By.xpath(obj.getProperty("CHHeaderSentTime")),driver)) 
			&& (s.isElementPresentcheck(By.xpath(obj.getProperty("CHHeaderCommandId")),driver)) && (s.isElementPresentcheck(By.xpath(obj.getProperty("CHHeaderSentBy")),driver)))
			{
	...
	public boolean saveAs(WebDriver driver, Properties obj)
	{
		...
		try
		{
			...
			Thread.sleep(5000);
			BufferedReader reader = new BufferedReader(new FileReader("\\\\AMXSERVER\\amx-share\\STW_QA\\Rtweb Automation\\Downloaded Excel\\CommandHistoryReport.xls"));
			String line;
			...
			WebElement ele = driver.findElement(By.xpath(".//*[@id='div-301-datagrid-tbody']"));
	...
	public boolean checkAll(WebDriver driver, Properties obj)
	{
		...
		{
			{
                driver.findElement(By.xpath(obj.getProperty("CHSelectAll"))).click();
                while(s.isElementPresentcheck(By.xpath(".//*[@id='DivOverlayChild']"), driver))
                {
